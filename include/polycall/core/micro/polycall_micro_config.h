 ...
 *
 * This file defines the configuration interface for the LibPolyCall micro
 * command system, providing structured configuration loading, validation, and
 * application for micro components and commands.
 */
...
typedef enum {
  ...
  MICRO_CONFIG_VALIDATION_REFERENCE_ERROR =
      6 // Invalid reference to another component
...
typedef struct {
  ...
  bool fallback_to_defaults; // Whether to fallback to defaults if config not
                             // found
  ...
  void (*error_callback)(    // Error callback for configuration issues
      polycall_core_context_t *ctx, const char *message, const char *file_path,
...
micro_config_manager_init(polycall_core_context_t *ctx,
 ...
 */
void micro_config_manager_cleanup(polycall_core_context_t *ctx,
                                  micro_config_manager_t *manager);
 ...
 */
polycall_core_error_t
micro_config_manager_load(polycall_core_context_t *ctx,
                          micro_config_manager_t *manager,
 ...
 */
polycall_core_error_t
micro_config_manager_apply(polycall_core_context_t *ctx,
                           micro_config_manager_t *manager,
...
polycall_core_error_t micro_config_manager_get_component_config(
    polycall_core_context_t *ctx, micro_config_manager_t *manager,
    const char *component_name, micro_component_config_t **config);
...
polycall_core_error_t micro_config_manager_get_all_components(
    polycall_core_context_t *ctx, micro_config_manager_t *manager,
    micro_component_config_t **configs, size_t *count);
 ...
 */
polycall_core_error_t
micro_config_manager_add_component(polycall_core_context_t *ctx,
                                   micro_config_manager_t *manager,
 ...
 */
polycall_core_error_t
micro_config_manager_remove_component(polycall_core_context_t *ctx,
                                      micro_config_manager_t *manager,
 ...
 */
polycall_core_error_t
micro_config_validate_component(polycall_core_context_t *ctx,
                                const micro_component_config_t *config,
 ...
 */
polycall_core_error_t
micro_config_create_default_component(polycall_core_context_t *ctx,
                                      const char *component_name,
 ...
 * @return Error code
 */
polycall_core_error_t micro_config_manager_save(polycall_core_context_t *ctx,
                                                micro_config_manager_t *manager,
