 ...
 * @brief Resource limitation and quota management for LibPolyCall micro command
 * system
...
typedef void (*resource_threshold_callback_t)(
    ...
    polycall_resource_type_t resource_type, size_t current_usage, size_t quota,
    void *user_data);
 ...
 */
polycall_core_error_t
resource_limiter_release(polycall_core_context_t *ctx,
                         resource_limiter_t *limiter,
                         polycall_resource_type_t resource_type, size_t amount);
 ...
 * @return Error code
 */
polycall_core_error_t resource_limiter_reset_usage(polycall_core_context_t *ctx,
                                                   resource_limiter_t *limiter);
