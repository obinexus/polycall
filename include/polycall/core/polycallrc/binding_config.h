 ...
 * providing APIs for loading, parsing, and accessing configurations from
 * .polycallrc files with enhanced read-only mode support.
 */
 ...
 * @param binding_ctx Pointer to receive the created binding configuration
 * context
 * @return polycall_core_error_t Success or error code
 */
polycall_core_error_t
polycall_binding_config_init(polycall_core_context_t *ctx,
 ...
 * @param file_path Path to configuration file, or NULL to search in standard
 * locations
 * @return polycall_core_error_t Success or error code
 */
polycall_core_error_t
polycall_binding_config_load(polycall_core_context_t *ctx,
                             polycall_binding_config_context_t *binding_ctx,
 ...
 */
polycall_core_error_t
polycall_binding_config_save(polycall_core_context_t *ctx,
                             polycall_binding_config_context_t *binding_ctx,
                             const char *file_path);
 ...
 */
polycall_core_error_t
polycall_binding_config_reset(polycall_core_context_t *ctx,
                              polycall_binding_config_context_t *binding_ctx);
...
polycall_core_error_t polycall_binding_config_get_string(
    polycall_core_context_t *ctx,
    polycall_binding_config_context_t *binding_ctx, const char *section,
 ...
 */
polycall_core_error_t
polycall_binding_config_get_int(polycall_core_context_t *ctx,
                                polycall_binding_config_context_t *binding_ctx,
 ...
 */
polycall_core_error_t
polycall_binding_config_get_bool(polycall_core_context_t *ctx,
                                 polycall_binding_config_context_t *binding_ctx,
                                 const char *section, const char *key,
                                 bool *value);
 ...
 */
polycall_core_error_t
polycall_binding_config_set_int(polycall_core_context_t *ctx,
                                polycall_binding_config_context_t *binding_ctx,
                                const char *section, const char *key,
                                int64_t value);
 ...
 */
polycall_core_error_t
polycall_binding_config_set_bool(polycall_core_context_t *ctx,
                                 polycall_binding_config_context_t *binding_ctx,
                                 const char *section, const char *key,
                                 bool value);
 ...
 * @param ctx Core context
 * @param binding_ctx Binding configuration context
 * @param path Full path to the configuration value (e.g.,
 * "micro.component_name.key")
 * @param value String representation of value
 * @return polycall_core_error_t Success or error code
 */
polycall_core_error_t polycall_binding_config_set_value(
    polycall_core_context_t *ctx,
    polycall_binding_config_context_t *binding_ctx, const char *path,
    const char *value);
...
polycall_core_error_t polycall_binding_config_serialize(
    polycall_core_context_t *ctx,
    polycall_binding_config_context_t *binding_ctx, FILE *file);
 ...
 */
polycall_core_error_t
polycall_binding_config_save(polycall_binding_config_context_t *config_ctx,
                             const char *file_path);
...
polycall_core_error_t polycall_binding_config_get_string(
    ...
    polycall_binding_config_context_t *config_ctx, const char *section_name,
 ...
 */
polycall_core_error_t
polycall_binding_config_get_int(polycall_core_context_t *core_ctx,
 ...
 */
polycall_core_error_t
polycall_binding_config_get_bool(polycall_core_context_t *core_ctx,
                                 polycall_binding_config_context_t *config_ctx,
                                 const char *section_name, const char *key,
                                 bool *value);
 ...
 */
polycall_core_error_t
polycall_binding_config_set_int(polycall_core_context_t *core_ctx,
                                polycall_binding_config_context_t *config_ctx,
                                const char *section_name, const char *key,
                                int64_t value);
 ...
 */
polycall_core_error_t
polycall_binding_config_set_bool(polycall_core_context_t *core_ctx,
                                 polycall_binding_config_context_t *config_ctx,
                                 const char *section_name, const char *key,
                                 bool value);
...
polycall_core_error_t polycall_binding_config_add_ignore_pattern(
    polycall_binding_config_context_t *config_ctx, const char *pattern);
...
bool polycall_binding_config_should_ignore(
    polycall_binding_config_context_t *config_ctx, const char *path);
...
polycall_core_error_t polycall_binding_config_load_ignore_file(
    polycall_binding_config_context_t *config_ctx, const char *file_path);
