 ...
 *
 * This file defines the interface for the PolycallRC-specific ignore pattern
 * system, which allows users to specify files and directories that should be
 * ignored by the binding configuration system during processing.
 */
...
polycallrc_ignore_init(polycall_core_context_t *core_ctx,
 ...
 */
void polycallrc_ignore_cleanup(polycall_core_context_t *core_ctx,
                               polycallrc_ignore_context_t *ignore_ctx);
 ...
 */
polycall_core_error_t
polycallrc_ignore_add_pattern(polycallrc_ignore_context_t *ignore_ctx,
                              const char *pattern);
 ...
 */
polycall_core_error_t
polycallrc_ignore_load_file(polycallrc_ignore_context_t *ignore_ctx,
 ...
 */
bool polycallrc_ignore_should_ignore(polycallrc_ignore_context_t *ignore_ctx,
                                     const char *path);
 ...
 */
size_t
polycallrc_ignore_get_pattern_count(polycallrc_ignore_context_t *ignore_ctx);
 ...
 */
const char *
polycallrc_ignore_get_pattern(polycallrc_ignore_context_t *ignore_ctx,
                              size_t index);
 ...
 */
polycall_core_error_t
polycallrc_ignore_add_defaults(polycallrc_ignore_context_t *ignore_ctx);
