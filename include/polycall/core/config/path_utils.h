 ...
 *
 * This header defines utilities for path manipulation, resolution, and
 * validation used throughout the LibPolyCall system.
 */
 ...
 * @return Error code
 */
polycall_core_error_t polycall_path_resolve(polycall_core_context_t *core_ctx,
                                            const char *path,
                                            char *resolved_path,
 ...
 * @return Error code
 */
polycall_core_error_t polycall_path_get_home_directory(char *home_path,
 ...
 */
bool polycall_path_file_exists(const char *path);
 ...
 */
bool polycall_path_is_directory(const char *path);
 ...
 * @return Error code
 */
polycall_core_error_t polycall_path_get_basename(const char *path,
                                                 char *basename,
 ...
 * @return Error code
 */
polycall_core_error_t polycall_path_get_dirname(const char *path, char *dirname,
                                                size_t dirname_size);
 ...
 * @return Error code
 */
polycall_core_error_t polycall_path_join(const char *base,
                                         const char *component, char *result,
                                         size_t result_size);
 ...
 * @return Error code
 */
polycall_core_error_t polycall_path_normalize(const char *path,
