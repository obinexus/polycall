...
polycall_global_config_init(polycall_core_context_t *core_ctx,
 ...
 */
polycall_core_error_t
polycall_global_config_load(polycall_global_config_context_t *config_ctx,
 ...
 *
 * @param config_ctx Configuration context
 * @param file_path Path to save configuration, or NULL for default/previous
 * path
 * @return polycall_core_error_t Success or error code
 */
polycall_core_error_t
polycall_global_config_save(polycall_global_config_context_t *config_ctx,
                            const char *file_path);
 ...
 *
 * @param config_ctx Configuration context
 * @param param_name Parameter name (can use dot notation, e.g.
 ...
 */
polycall_core_error_t
polycall_global_config_get_param(polycall_global_config_context_t *config_ctx,
                                 const char *param_name, void *param_value,
                                 size_t value_size);
 ...
 */
polycall_core_error_t
polycall_global_config_set_param(polycall_global_config_context_t *config_ctx,
 ...
 */
polycall_core_error_t
polycall_global_config_get(polycall_global_config_context_t *config_ctx,
 ...
 */
polycall_core_error_t
polycall_global_config_set(polycall_global_config_context_t *config_ctx,
                           const polycall_global_config_t *config);
 ...
 */
bool polycall_global_config_validate(const polycall_global_config_t *config,
                                     char *error_message,
...
void polycall_global_config_apply_to_micro(
    polycall_global_config_context_t *config_ctx, void *micro_config);
...
void polycall_global_config_apply_to_network(
    polycall_global_config_context_t *config_ctx, void *network_config);
...
void polycall_global_config_apply_to_protocol(
    polycall_global_config_context_t *config_ctx, void *protocol_config);
