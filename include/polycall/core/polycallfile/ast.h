 ...
 */
polycall_ast_node_t *polycall_ast_node_create(polycall_ast_node_type_t type,
                                              const char *name);
 ...
 */
bool polycall_ast_node_add_child(polycall_ast_node_t *parent,
                                 polycall_ast_node_t *child);
 ...
 */
polycall_ast_node_t *polycall_ast_node_find_child(polycall_ast_node_t *parent,
                                                  const char *name);
 ...
 * @return polycall_ast_node_t* The found node, or NULL if not found
 */
polycall_ast_node_t *polycall_ast_node_find_path(polycall_ast_node_t *root,
                                                 const char *path);
 ...
 * @return polycall_ast_node_t* The found node, or NULL if not found
 */
polycall_ast_node_t *polycall_ast_find_node(polycall_ast_t *ast,
                                            const char *path);
