 ...
 */
polycall_expression_evaluator_t *
polycall_expression_evaluator_create(polycall_ast_t *ast, bool strict_mode);
 ...
 */
void polycall_expression_evaluator_destroy(
 ...
 */
polycall_value_t
polycall_expression_evaluate(polycall_expression_evaluator_t *evaluator,
 ...
 */
const char *
polycall_expression_get_error(polycall_expression_evaluator_t *evaluator);
 ...
 */
int polycall_value_as_string(polycall_value_t value, char *buffer,
                             size_t buffer_size);
