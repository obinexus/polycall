...
typedef struct polycall_core_config {
  ...
  void (*error_callback)(void *user_data,
                         const char *message); /**< Error callback function */
...
typedef struct {
   ...
   * @param user_data User data for the provider
   */
  void (*cleanup)(polycall_core_context_t *ctx, void *user_data);
   ...
   * @return Error code
   */
  polycall_core_error_t (*load)(polycall_core_context_t *ctx, void *user_data,
   ...
   * @return Error code
   */
  polycall_core_error_t (*save)(polycall_core_context_t *ctx, void *user_data,
                                polycall_config_section_t section_id,
                                const char *key,
   ...
   * @return Error code
   */
  polycall_core_error_t (*exists)(polycall_core_context_t *ctx, void *user_data,
                                  polycall_config_section_t section_id,
   ...
   * @return Error code
   */
  polycall_core_error_t (*enumerate)(polycall_core_context_t *ctx,
                                     void *user_data,
                                     polycall_config_section_t section_id,
...
polycall_config_init(polycall_core_context_t *ctx,
 ...
 */
void polycall_config_cleanup(polycall_core_context_t *ctx,
                             polycall_config_context_t *config_ctx);
 ...
 */
polycall_core_error_t
polycall_config_load(polycall_core_context_t *ctx,
                     polycall_config_context_t *config_ctx,
 ...
 */
polycall_core_error_t
polycall_config_save(polycall_core_context_t *ctx,
                     polycall_config_context_t *config_ctx,
                     const char *file_path);
 ...
 */
polycall_core_error_t
polycall_config_register_provider(polycall_core_context_t *ctx,
                                  polycall_config_context_t *config_ctx,
...
typedef void (*polycall_config_change_handler_t)(
    polycall_core_context_t *ctx, polycall_config_section_t section_id,
    const char *key, const polycall_config_value_t *old_value,
    const polycall_config_value_t *new_value, void *user_data);
...
polycall_core_error_t polycall_config_register_change_handler(
    polycall_core_context_t *ctx, polycall_config_context_t *config_ctx,
    polycall_config_section_t section_id, const char *key,
    polycall_config_change_handler_t handler, void *user_data,
    uint32_t *handler_id);
 ...
 */
bool polycall_config_get_bool(polycall_core_context_t *ctx,
                              polycall_config_context_t *config_ctx,
                              polycall_config_section_t section_id,
...
polycall_core_error_t polycall_config_set_bool(
    polycall_core_context_t *ctx, polycall_config_context_t *config_ctx,
    polycall_config_section_t section_id, const char *key, bool value);
 ...
 */
int64_t polycall_config_get_int(polycall_core_context_t *ctx,
                                polycall_config_context_t *config_ctx,
                                polycall_config_section_t section_id,
 ...
 * @return Error code
 */
polycall_error_t polycall_load_config_file(polycall_core_context_t *ctx,
...
polycall_core_error_t polycall_config_set_int(
    polycall_core_context_t *ctx, polycall_config_context_t *config_ctx,
    polycall_config_section_t section_id, const char *key, int64_t value);
 ...
 * @return Float value
 */
double polycall_config_get_float(polycall_core_context_t *ctx,
                                 polycall_config_context_t *config_ctx,
                                 polycall_config_section_t section_id,
...
polycall_core_error_t polycall_config_set_float(
    polycall_core_context_t *ctx, polycall_config_context_t *config_ctx,
    polycall_config_section_t section_id, const char *key, double value);
...
polycall_core_error_t polycall_config_get_string(
    polycall_core_context_t *ctx, polycall_config_context_t *config_ctx,
    polycall_config_section_t section_id, const char *key, char *buffer,
...
polycall_core_error_t polycall_config_set_string(
    polycall_core_context_t *ctx, polycall_config_context_t *config_ctx,
    polycall_config_section_t section_id, const char *key, const char *value);
...
polycall_core_error_t polycall_config_get_object(
    polycall_core_context_t *ctx, polycall_config_context_t *config_ctx,
    polycall_config_section_t section_id, const char *key, void **value);
 ...
 */
bool polycall_config_exists(polycall_core_context_t *ctx,
                            polycall_config_context_t *config_ctx,
                            polycall_config_section_t section_id,
                            const char *key);
 ...
 */
polycall_core_error_t
polycall_config_remove(polycall_core_context_t *ctx,
                       polycall_config_context_t *config_ctx,
                       polycall_config_section_t section_id, const char *key);
...
polycall_core_error_t polycall_config_enumerate(
    polycall_core_context_t *ctx, polycall_config_context_t *config_ctx,
    polycall_config_section_t section_id,
    void (*callback)(const char *key, void *user_data), void *user_data);
