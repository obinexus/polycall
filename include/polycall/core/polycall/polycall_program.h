...
typedef struct {
  ...
  void (*execute)(                /**< Execution function */
                  polycall_core_context_t *ctx, const polycall_value_t *inputs,
                  size_t input_count, polycall_value_t *outputs,
...
polycall_program_create_graph(polycall_core_context_t *ctx,
                              polycall_program_graph_t **graph,
                              const char *name, polycall_program_flags_t flags);
 ...
 */
void polycall_program_destroy_graph(polycall_core_context_t *ctx,
                                    polycall_program_graph_t *graph);
...
polycall_core_error_t polycall_program_create_node(
    polycall_core_context_t *ctx, polycall_program_graph_t *graph,
    polycall_program_node_t **node, const polycall_operation_t *operation);
 ...
 */
void polycall_program_destroy_node(polycall_core_context_t *ctx,
...
polycall_core_error_t polycall_program_connect_nodes(
    polycall_core_context_t *ctx, polycall_program_node_t *source,
    size_t source_output, polycall_program_node_t *target, size_t target_input);
 ...
 * @return Error code indicating success or failure
 */
polycall_core_error_t polycall_program_set_input(polycall_core_context_t *ctx,
                                                 polycall_program_node_t *node,
                                                 size_t input_index,
 ...
 * @return Error code indicating success or failure
 */
polycall_core_error_t polycall_program_get_output(polycall_core_context_t *ctx,
                                                  polycall_program_node_t *node,
                                                  size_t output_index,
 ...
 */
polycall_core_error_t
polycall_program_execute_node(polycall_core_context_t *ctx,
                              polycall_program_node_t *node);
 ...
 */
polycall_core_error_t
polycall_program_execute_graph(polycall_core_context_t *ctx,
                               polycall_program_graph_t *graph);
 ...
 */
polycall_core_error_t
polycall_program_optimize_graph(polycall_core_context_t *ctx,
                                polycall_program_graph_t *graph,
 ...
 */
polycall_core_error_t
polycall_program_validate_graph(polycall_core_context_t *ctx,
                                polycall_program_graph_t *graph);
 ...
 */
polycall_core_error_t
polycall_program_serialize_graph(polycall_core_context_t *ctx,
                                 polycall_program_graph_t *graph, void **data,
                                 size_t *size);
 ...
 */
polycall_core_error_t
polycall_program_deserialize_graph(polycall_core_context_t *ctx,
                                   polycall_program_graph_t **graph,
 ...
 */
polycall_core_error_t
polycall_program_create_value(polycall_core_context_t *ctx,
                              polycall_value_t *value,
 ...
 */
void polycall_program_destroy_value(polycall_core_context_t *ctx,
                                    polycall_value_t *value);
...
polycall_core_error_t polycall_program_create_operation(
    polycall_core_context_t *ctx, polycall_operation_t *operation,
    polycall_operation_type_t type, const char *name);
...
polycall_core_error_t polycall_program_create_custom_operation(
    polycall_core_context_t *ctx, polycall_operation_t *operation,
    const char *name, size_t input_count, size_t output_count,
    void (*execute)(polycall_core_context_t *ctx,
                    const polycall_value_t *inputs, size_t input_count,
                    polycall_value_t *outputs, size_t output_count,
                    void *user_data),
    void *user_data);
 ...
 */
void polycall_program_destroy_operation(polycall_core_context_t *ctx,
 ...
 */
polycall_core_error_t
polycall_program_clone_graph(polycall_core_context_t *ctx,
...
polycall_core_error_t polycall_program_get_node_info(
    polycall_core_context_t *ctx, const polycall_program_node_t *node,
    polycall_operation_t *operation, size_t *input_count, size_t *output_count);
...
polycall_core_error_t polycall_program_get_graph_stats(
    polycall_core_context_t *ctx, const polycall_program_graph_t *graph,
    size_t *node_count, size_t *edge_count, size_t *depth);
...
polycall_core_error_t polycall_program_register_data_type(
    polycall_core_context_t *ctx, polycall_data_type_t *type_id,
    const char *type_name,
    size_t (*serializer)(polycall_core_context_t *ctx, const void *data,
                         void **buffer, size_t *buffer_size, void *user_data),
    void *(*deserializer)(polycall_core_context_t *ctx, const void *buffer,
...
polycall_core_error_t polycall_program_create_composite_operation(
    polycall_core_context_t *ctx, polycall_operation_t *operation,
    const polycall_program_graph_t *subgraph, const char *name);
