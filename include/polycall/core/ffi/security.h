 ...
 */
typedef void (*audit_callback_t)(polycall_core_context_t *ctx,
                                 const audit_event_t *event, void *user_data);
 ...
 * @return Error code
 */
polycall_core_error_t polycall_security_init(polycall_core_context_t *ctx,
 ...
 */
void polycall_security_cleanup(polycall_core_context_t *ctx,
                               polycall_ffi_context_t *ffi_ctx,
                               security_context_t *security_ctx);
...
polycall_core_error_t polycall_security_verify_access(
    ...
    security_context_t *security_ctx, const char *function_name,
    const char *source_language, const char *source_context,
...
polycall_core_error_t polycall_security_register_function(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    security_context_t *security_ctx, const char *function_name,
    const char *source_language, polycall_permission_set_t required_permissions,
...
polycall_core_error_t polycall_security_audit_event(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    security_context_t *security_ctx, const char *source_language,
    const char *target_language, const char *function_name, const char *action,
    security_result_t *result, const char *details);
...
polycall_core_error_t polycall_security_register_audit_callback(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    security_context_t *security_ctx, audit_callback_t callback,
    void *user_data);
...
polycall_core_error_t polycall_security_enforce_isolation(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    security_context_t *security_ctx, const char *source_language,
    const char *target_language, polycall_isolation_level_t isolation_level);
...
polycall_core_error_t polycall_security_validate_parameters(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    security_context_t *security_ctx, const char *function_name,
    const ffi_value_t *params, size_t param_count, security_result_t *result);
...
polycall_core_error_t polycall_security_load_policy(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    security_context_t *security_ctx, const char *policy_file);
...
polycall_core_error_t polycall_security_add_policy_entry(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    security_context_t *security_ctx, const security_policy_entry_t *entry);
...
polycall_core_error_t polycall_security_remove_policy_entry(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    security_context_t *security_ctx, const char *function_id,
 ...
 */
polycall_security_level_t
polycall_security_get_level(polycall_core_context_t *ctx,
                            polycall_ffi_context_t *ffi_ctx,
                            security_context_t *security_ctx);
