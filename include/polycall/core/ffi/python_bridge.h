...
polycall_python_bridge_init(polycall_core_context_t *ctx,
 ...
 */
void polycall_python_bridge_cleanup(polycall_core_context_t *ctx,
                                    polycall_ffi_context_t *ffi_ctx,
                                    polycall_python_bridge_t *python_bridge);
...
polycall_core_error_t polycall_python_bridge_register_function(
    ...
    polycall_python_bridge_t *python_bridge, const char *function_name,
    const char *module_name, const char *py_function_name,
...
polycall_core_error_t polycall_python_bridge_to_python_value(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_python_bridge_t *python_bridge, const ffi_value_t *ffi_value,
    void **py_value);
...
polycall_core_error_t polycall_python_bridge_from_python_value(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_python_bridge_t *python_bridge, void *py_value,
...
polycall_core_error_t polycall_python_bridge_exec_code(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_python_bridge_t *python_bridge, const char *code,
    const char *module_name, ffi_value_t *result);
...
polycall_core_error_t polycall_python_bridge_import_module(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_python_bridge_t *python_bridge, const char *module_name);
...
polycall_core_error_t polycall_python_bridge_handle_exception(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_python_bridge_t *python_bridge, char *error_message,
    size_t message_size);
 ...
 */
polycall_core_error_t
polycall_python_bridge_get_version(polycall_core_context_t *ctx,
                                   polycall_ffi_context_t *ffi_ctx,
                                   polycall_python_bridge_t *python_bridge,
...
polycall_core_error_t polycall_python_bridge_gil_control(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_python_bridge_t *python_bridge, bool acquire);
...
polycall_core_error_t polycall_python_bridge_get_interface(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_python_bridge_t *python_bridge, language_bridge_t *bridge);
 ...
 */
polycall_python_bridge_config_t
polycall_python_bridge_create_default_config(void);
