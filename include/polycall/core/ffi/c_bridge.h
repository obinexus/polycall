...
polycall_core_error_t polycall_c_bridge_init(
    ...
    polycall_c_bridge_t **c_bridge, const polycall_c_bridge_config_t *config);
 ...
 */
void polycall_c_bridge_cleanup(polycall_core_context_t *ctx,
...
polycall_core_error_t polycall_c_bridge_register_function(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_c_bridge_t *c_bridge, const char *function_name,
    void *function_ptr, polycall_ffi_type_t return_type,
    polycall_ffi_type_t *param_types, size_t param_count, uint32_t flags);
...
polycall_core_error_t polycall_c_bridge_call_function(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_c_bridge_t *c_bridge, const char *function_name, ffi_value_t *args,
...
polycall_core_error_t polycall_c_bridge_register_struct(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_c_bridge_t *c_bridge, const char *struct_name,
    polycall_ffi_type_t *field_types, const char **field_names,
    size_t *field_offsets, size_t field_count, size_t struct_size,
    size_t alignment);
...
polycall_core_error_t polycall_c_bridge_setup_callback(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_c_bridge_t *c_bridge, ffi_type_info_t *callback_type,
...
polycall_core_error_t polycall_c_bridge_get_interface(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_c_bridge_t *c_bridge, language_bridge_t *bridge);
