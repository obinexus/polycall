...
typedef struct {
  ...
  struct {
    ...
    void (*on_auth_request)(struct polycall_protocol_context *ctx,
                            const void *credentials);
    void (*on_command)(struct polycall_protocol_context *ctx, const void *data,
                       size_t length);
    void (*on_error)(struct polycall_protocol_context *ctx,
 ...
 */
bool polycall_protocol_init(polycall_protocol_context_t *ctx,
 ...
 * @return true if successful, false otherwise
 */
bool polycall_protocol_send(polycall_protocol_context_t *ctx,
 ...
 * @return true if successful, false otherwise
 */
bool polycall_protocol_process(polycall_protocol_context_t *ctx,
 ...
 */
polycall_protocol_state_t
polycall_protocol_get_state(const polycall_protocol_context_t *ctx);
 ...
 */
bool polycall_protocol_can_transition(const polycall_protocol_context_t *ctx,
 ...
 * @return true if successful, false otherwise
 */
bool polycall_protocol_authenticate(polycall_protocol_context_t *ctx,
...
bool polycall_protocol_verify_checksum(
    const polycall_protocol_msg_header_t *header, const void *payload,
 ...
 */
void polycall_protocol_set_error(polycall_protocol_context_t *ctx,
                                 const char *error);
