 ...
 *
 * This header defines the comprehensive configuration interface for the
 * protocol module and all its enhancements, providing a unified initialization
 * and management API.
 */
...
typedef struct {
  ...
  uint32_t
      state_timeout_ms; /**< State timeout for prevention of stuck states */
...
typedef struct {
  ...
  polycall_protocol_enhancements_config_t
      enhancements; /**< Enhancements configuration */
} protocol_config_t;
...
polycall_protocol_config_init(polycall_core_context_t *core_ctx,
 ...
 *
 * This function applies the configuration to an already initialized protocol
 * context.
 *
 * @param core_ctx Core context
 ...
 */
polycall_core_error_t
polycall_protocol_apply_config(polycall_core_context_t *core_ctx,
                               polycall_protocol_context_t *proto_ctx,
                               const protocol_config_t *config);
 ...
 */
polycall_core_error_t
polycall_protocol_load_config(polycall_core_context_t *core_ctx,
 ...
 */
polycall_core_error_t
polycall_protocol_save_config(polycall_core_context_t *core_ctx,
                              const char *config_file,
                              const protocol_config_t *config);
 ...
 */
bool polycall_protocol_validate_config(polycall_core_context_t *core_ctx,
                                       const protocol_config_t *config,
                                       char *error_message,
                                       size_t message_size);
 ...
 */
polycall_core_error_t
polycall_protocol_merge_config(polycall_core_context_t *core_ctx,
 ...
 */
polycall_core_error_t
polycall_protocol_copy_config(polycall_core_context_t *core_ctx,
                              protocol_config_t *dest,
                              const protocol_config_t *src);
 ...
 */
void *polycall_protocol_get_config_schema(polycall_core_context_t *core_ctx);
 ...
 */
size_t polycall_protocol_print_config(polycall_core_context_t *core_ctx,
                                      const protocol_config_t *config,
