...
typedef struct {
  ...
  void (*handler)(polycall_network_context_t *ctx,
...
struct polycall_network_context {
  ...
  // Event handlers
  event_handler_t event_handlers[POLYCALL_NETWORK_EVENT_COUNT]
                                [MAX_EVENT_HANDLERS];
...
static void trigger_event(polycall_network_context_t *ctx,
                          polycall_endpoint_t *endpoint,
                          polycall_network_event_t event_type,
                          void *event_data);
static polycall_core_error_t
initialize_thread_pool(polycall_core_context_t *core_ctx,
                       polycall_network_context_t *network_ctx,
                       uint32_t thread_count);
static void cleanup_thread_pool(polycall_core_context_t *core_ctx,
                                polycall_network_context_t *network_ctx);
static polycall_core_error_t
initialize_tls_context(polycall_core_context_t *core_ctx,
                       polycall_network_context_t *network_ctx);
static void cleanup_tls_context(polycall_core_context_t *core_ctx,
                                polycall_network_context_t *network_ctx);
static polycall_core_error_t
register_endpoint(polycall_core_context_t *core_ctx,
                  polycall_network_context_t *network_ctx,
                  polycall_endpoint_t *endpoint);
static polycall_core_error_t
unregister_endpoint(polycall_core_context_t *core_ctx,
                    polycall_network_context_t *network_ctx,
                    polycall_endpoint_t *endpoint);
static polycall_core_error_t
register_client(polycall_core_context_t *core_ctx,
                polycall_network_context_t *network_ctx,
                polycall_network_client_t *client);
static polycall_core_error_t
unregister_client(polycall_core_context_t *core_ctx,
                  polycall_network_context_t *network_ctx,
                  polycall_network_client_t *client);
static polycall_core_error_t
register_server(polycall_core_context_t *core_ctx,
                polycall_network_context_t *network_ctx,
                polycall_network_server_t *server);
static polycall_core_error_t
unregister_server(polycall_core_context_t *core_ctx,
                  polycall_network_context_t *network_ctx,
                  polycall_network_server_t *server);
static void update_statistics(polycall_network_context_t *network_ctx,
                              polycall_network_event_t event_type);
...
struct polycall_network_config {
  ...
  void (*error_callback)(         // Error callback
      polycall_network_context_t *ctx, polycall_core_error_t error,
...
polycall_network_init(polycall_core_context_t *core_ctx,
                      polycall_network_context_t **network_ctx,
 ...
 */
void polycall_network_cleanup(polycall_core_context_t *core_ctx,
                              polycall_network_context_t *network_ctx);
...
polycall_core_error_t polycall_network_create_client(
    polycall_core_context_t *core_ctx, polycall_network_context_t *network_ctx,
    polycall_protocol_context_t *proto_ctx, polycall_network_client_t **client,
...
polycall_core_error_t polycall_network_create_server(
    polycall_core_context_t *core_ctx, polycall_network_context_t *network_ctx,
    polycall_protocol_context_t *proto_ctx, polycall_network_server_t **server,
 ...
 */
polycall_core_error_t
polycall_network_get_stats(polycall_core_context_t *core_ctx,
                           polycall_network_context_t *network_ctx,
                           polycall_network_stats_t *stats);
 ...
 */
polycall_core_error_t
polycall_network_process_events(polycall_core_context_t *core_ctx,
                                polycall_network_context_t *network_ctx,
                                uint32_t timeout_ms);
...
polycall_core_error_t polycall_network_set_option(
    polycall_core_context_t *core_ctx, polycall_network_context_t *network_ctx,
    polycall_network_option_t option, const void *value, size_t size);
...
polycall_core_error_t polycall_network_get_option(
    polycall_core_context_t *core_ctx, polycall_network_context_t *network_ctx,
    polycall_network_option_t option, void *value, size_t *size);
...
polycall_core_error_t polycall_network_create_packet(
    polycall_core_context_t *core_ctx, polycall_network_context_t *network_ctx,
    polycall_network_packet_t **packet, size_t initial_capacity);
...
polycall_core_error_t polycall_network_connect(
    polycall_core_context_t *core_ctx, polycall_network_context_t *network_ctx,
    polycall_protocol_context_t *proto_ctx, const char *address, uint16_t port,
    uint32_t timeout_ms, polycall_endpoint_t **endpoint);
 ...
 */
polycall_core_error_t
polycall_network_listen(polycall_core_context_t *core_ctx,
                        polycall_network_context_t *network_ctx,
                        polycall_protocol_context_t *proto_ctx, uint16_t port,
                        uint32_t backlog, polycall_network_server_t **server);
 ...
 * @param response Pointer to receive response message (NULL if no response
 * expected)
 * @return Error code
 */
polycall_core_error_t polycall_network_send_message(
    polycall_core_context_t *core_ctx, polycall_network_context_t *network_ctx,
    polycall_protocol_context_t *proto_ctx, polycall_endpoint_t *endpoint,
    polycall_message_t *message, uint32_t timeout_ms,
