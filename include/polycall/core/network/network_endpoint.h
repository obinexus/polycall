...
typedef struct event_handler {
  ...
  void (*handler)(                     // Handler function
      polycall_network_context_t *ctx, polycall_endpoint_t *endpoint,
...
typedef struct {
  ...
  void (*callback)(polycall_endpoint_t *endpoint, void *event_data,
                   void *user_data);
  void *user_data;
} endpoint_callback_t;
...
struct polycall_network_server_config {
  ...
  bool
      enable_protocol_dispatch; // Enable automatic protocol message dispatching
...
polycall_network_server_create(polycall_core_context_t *ctx,
 ...
 */
polycall_core_error_t
polycall_network_server_start(polycall_core_context_t *ctx,
                              polycall_network_server_t *server);
 ...
 */
polycall_core_error_t
polycall_network_server_stop(polycall_core_context_t *ctx,
                             polycall_network_server_t *server);
 ...
 */
polycall_core_error_t
polycall_network_server_disconnect(polycall_core_context_t *ctx,
                                   polycall_network_server_t *server,
...
polycall_core_error_t polycall_network_server_register_handler(
    polycall_core_context_t *ctx, polycall_network_server_t *server,
    uint32_t message_type, polycall_message_handler_t handler, void *user_data);
 ...
 */
polycall_core_error_t
polycall_network_server_get_stats(polycall_core_context_t *ctx,
                                  polycall_network_server_t *server,
                                  polycall_network_stats_t *stats);
 ...
 */
polycall_core_error_t
polycall_network_server_process_events(polycall_core_context_t *ctx,
                                       polycall_network_server_t *server,
                                       uint32_t timeout_ms);
