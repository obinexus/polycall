 ...
 * the execution context for distributed computational tasks, providing
 * isolation, resource management, and communication channels between edge
 * nodes.
 */
...
typedef void (*polycall_edge_runtime_task_callback_t)(
    ...
    polycall_edge_task_metrics_t *metrics, void *user_data);
...
polycall_edge_runtime_init(polycall_core_context_t *core_ctx,
...
polycall_core_error_t polycall_edge_runtime_submit_task(
    polycall_edge_runtime_context_t *runtime_ctx, const void *task_data,
    size_t task_size, uint8_t priority,
 ...
 */
polycall_core_error_t
polycall_edge_runtime_check_task(polycall_edge_runtime_context_t *runtime_ctx,
                                 uint64_t task_id,
                                 polycall_edge_task_state_t *task_state,
 ...
 */
polycall_core_error_t
polycall_edge_runtime_cancel_task(polycall_edge_runtime_context_t *runtime_ctx,
                                  uint64_t task_id);
...
polycall_core_error_t polycall_edge_runtime_get_stats(
    polycall_edge_runtime_context_t *runtime_ctx, uint64_t *total_tasks,
    uint64_t *completed_tasks, uint64_t *failed_tasks,
...
polycall_core_error_t polycall_edge_runtime_register_handler(
    polycall_edge_runtime_context_t *runtime_ctx, uint32_t task_type,
    void (*handler)(void *task_data, size_t task_size, void *result_buffer,
