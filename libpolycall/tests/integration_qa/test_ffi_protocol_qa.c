 ...
 */
int main(void) {
    printf("Starting INTEGRATION_QA tests for modules: ffi protocol\n");
    printf("===========================================\n");
    ...
    printf("===========================================\n");
    printf("✅ All INTEGRATION_QA tests passed for modules: ffi protocol\n");
