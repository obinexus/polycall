 ...
 * @brief UNIT_QA tests for cli/polycall module
...
#include <polycall/cli/polycall/polycall.h>
...
static void setup_test_fixture(void) {
    ...
    result = polycall_polycall_init(g_fixture.core_ctx, &g_fixture.polycall_ctx, NULL);
    assert(result == POLYCALL_CORE_SUCCESS);
 ...
 */
int main(void) {
    printf("Starting UNIT_QA tests for cli/polycall\n");
    printf("==============================================\n");
    ...
    printf("==============================================\n");
    printf("✅ All UNIT_QA tests passed for cli/polycall\n");
