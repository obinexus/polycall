 ...
 * @brief UNIT_QA tests for cli/protocol module
...
#include <polycall/cli/protocol/protocol.h>
 ...
 */
int main(void) {
    printf("Starting UNIT_QA tests for cli/protocol\n");
    printf("==============================================\n");
    ...
    printf("==============================================\n");
    printf("✅ All UNIT_QA tests passed for cli/protocol\n");
