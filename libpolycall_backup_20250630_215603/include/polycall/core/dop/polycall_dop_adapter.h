...
polycall_core_error_t polycall_dop_adapter_init(
    ...
    polycall_protocol_context_t* proto_ctx,                // Protocol context for state integration
...
polycall_core_error_t polycall_dop_adapter_destroy(
...
polycall_core_error_t polycall_dop_adapter_to_oop(
    polycall_core_context_t* ctx,
    polycall_dop_adapter_context_t* adapter_ctx,
...
polycall_core_error_t polycall_dop_adapter_reset(
    polycall_core_context_t* ctx,
    polycall_dop_adapter_context_t* adapter_ctx,
