...
static void mock_error_handler(polycall_core_context_t *ctx,
  ...
  polycall_test_log_info("Mock handler called: component=%s, source=%d, "
                         "code=%d, severity=%d, message=%s",
...
POLYCALL_TEST_MAIN(hierarchical_error_register_handler_register,
