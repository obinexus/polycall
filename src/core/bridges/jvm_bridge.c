 ...
 * languages through the FFI system. It handles JNI integration, method
registration,
 ...
 */
static polycall_core_error_t check_java_exception(polycall_core_context_t *ctx,
                                                  JNIEnv *env,
                                                  char *error_message,
                                                  size_t message_size) {
  if ((*env)->ExceptionCheck(env)) {
    ...
    jmethodID toString_method = (*env)->GetMethodID(
        env, exception_class, "toString", "()Ljava/lang/String;");
    jstring jmessage =
        (jstring)(*env)->CallObjectMethod(env, exception, toString_method);
    ...
    // Log error
    POLYCALL_ERROR_SET(
        ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_EXECUTION_FAILED,
        POLYCALL_ERROR_SEVERITY_ERROR, "Java exception: %s", message_chars);
 ...
 */
static polycall_core_error_t create_jvm(polycall_core_context_t *ctx,
  ...
  if (jvm_bridge->config.jvm_options) {
    ...
    options = (JavaVMOption *)polycall_core_malloc(ctx, sizeof(JavaVMOption) *
                                                            option_count);
    if (!options) {
      return POLYCALL_CORE_ERROR_OUT_OF_MEMORY;
    }
  ...
  if (jvm_bridge->config.classpath) {
    classpath_option =
        (JavaVMOption *)polycall_core_malloc(ctx, sizeof(JavaVMOption));
    if (!classpath_option) {
      if (options)
        polycall_core_free(ctx, options);
      if (jvm_options_copy)
    ...
    size_t cp_size =
        strlen("-Djava.class.path=") + strlen(jvm_bridge->config.classpath) + 1;
    ...
    snprintf(cp_string, cp_size, "-Djava.class.path=%s",
             jvm_bridge->config.classpath);
  ...
  if (vm_args.nOptions > 0) {
    all_options = (JavaVMOption *)polycall_core_malloc(
        ctx, sizeof(JavaVMOption) * vm_args.nOptions);
    if (!all_options) {
      if (classpath_option) {
  ...
  if (all_options)
    polycall_core_free(ctx, all_options);
  if (classpath_option) {
    polycall_core_free(ctx, (void *)classpath_option->optionString);
    polycall_core_free(ctx, classpath_option);
  }
...
init_bridge_class(polycall_core_context_t *ctx,
                  polycall_jvm_bridge_t *jvm_bridge) {
 ...
 */
static polycall_core_error_t
init_method_registry(polycall_core_context_t *ctx,
                     polycall_jvm_bridge_t *jvm_bridge, size_t capacity) {
  // Allocate method registry
  jvm_bridge->methods =
      polycall_core_malloc(ctx, capacity * sizeof(java_method_entry_t));
 ...
 */
static void cleanup_method_registry(polycall_core_context_t *ctx,
                                    polycall_jvm_bridge_t *jvm_bridge) {
  if (!jvm_bridge->methods) {
    return;
  }
 ...
 */
static polycall_core_error_t
init_callback_registry(polycall_core_context_t *ctx,
                       polycall_jvm_bridge_t *jvm_bridge, size_t capacity) {
  // Allocate callback registry
  jvm_bridge->callbacks =
      polycall_core_malloc(ctx, capacity * sizeof(java_callback_t));
 ...
 */
static void cleanup_callback_registry(polycall_core_context_t *ctx,
                                      polycall_jvm_bridge_t *jvm_bridge) {
  if (!jvm_bridge->callbacks) {
    return;
  }
 ...
 */
static java_method_entry_t *find_method(polycall_jvm_bridge_t *jvm_bridge,
 ...
 */
static java_callback_t *find_callback(polycall_jvm_bridge_t *jvm_bridge,
                                      const char *callback_class,
                                      const char *callback_method) {
  for (size_t i = 0; i < jvm_bridge->callback_count; i++) {
    if (strcmp(jvm_bridge->callbacks[i].callback_class, callback_class) == 0 &&
        strcmp(jvm_bridge->callbacks[i].callback_method, callback_method) ==
            0) {
 ...
 */
static jobject ffi_to_java_value(polycall_core_context_t *ctx,
                                 polycall_jvm_bridge_t *jvm_bridge, JNIEnv *env,
  ...
  case POLYCALL_FFI_TYPE_BOOL: {
    ...
    jobject result = (*env)->NewObject(env, boolean_class, constructor,
                                       (jboolean)ffi_value->value.bool_value);
  ...
  case POLYCALL_FFI_TYPE_CHAR: {
    ...
    jmethodID constructor =
        (*env)->GetMethodID(env, char_class, "<init>", "(C)V");
    jobject result = (*env)->NewObject(env, char_class, constructor,
                                       (jchar)ffi_value->value.char_value);
  ...
  case POLYCALL_FFI_TYPE_INT32: {
    ...
    jmethodID constructor =
        (*env)->GetMethodID(env, integer_class, "<init>", "(I)V");
    jint value;
  ...
  case POLYCALL_FFI_TYPE_INT64: {
    ...
    jmethodID constructor =
        (*env)->GetMethodID(env, long_class, "<init>", "(J)V");
    jobject result = (*env)->NewObject(env, long_class, constructor,
                                       (jlong)ffi_value->value.int64_value);
  ...
  case POLYCALL_FFI_TYPE_UINT64: {
    ...
    jmethodID constructor =
        (*env)->GetMethodID(env, long_class, "<init>", "(J)V");
    jobject result = (*env)->NewObject(env, long_class, constructor,
                                       (jlong)ffi_value->value.uint64_value);
    (*env)->DeleteLocalRef(env, long_class);
    return result;
  }
  ...
  case POLYCALL_FFI_TYPE_FLOAT: {
    ...
    jmethodID constructor =
        (*env)->GetMethodID(env, float_class, "<init>", "(F)V");
    jobject result = (*env)->NewObject(env, float_class, constructor,
                                       (jfloat)ffi_value->value.float_value);
  ...
  case POLYCALL_FFI_TYPE_DOUBLE: {
    ...
    jobject result = (*env)->NewObject(env, double_class, constructor,
                                       (jdouble)ffi_value->value.double_value);
  ...
  case POLYCALL_FFI_TYPE_POINTER: {
    ...
    return (*env)->NewDirectByteBuffer(env, ffi_value->value.pointer_value,
                                       size);
  }
...
polycall_jvm_bridge_init(polycall_core_context_t *ctx,
  ...
  polycall_jvm_bridge_t *new_bridge =
      polycall_core_malloc(ctx, sizeof(polycall_jvm_bridge_t));
  if (!new_bridge) {
    POLYCALL_ERROR_SET(
        ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_OUT_OF_MEMORY,
        POLYCALL_ERROR_SEVERITY_ERROR, "Failed to allocate JVM bridge context");
    return POLYCALL_CORE_ERROR_OUT_OF_MEMORY;
  }
  ...
  polycall_core_error_t result =
      init_method_registry(ctx, new_bridge, 64); // Default capacity
  ...
  if (config->bridge_class) {
    ...
    if (result != POLYCALL_CORE_SUCCESS) {
      if (new_bridge->owns_jvm) {
        // Destroy JVM - not implemented here as it's complex and often
        // unnecessary JVM usually handles its own shutdown via atexit()
        // handlers
      }
      cleanup_callback_registry(ctx, new_bridge);
      cleanup_method_registry(ctx, new_bridge);
  ...
  result = polycall_ffi_register_language(ctx, ffi_ctx, "java",
                                          &new_bridge->bridge_interface);
  if (result != POLYCALL_CORE_SUCCESS &&
      result != POLYCALL_CORE_ERROR_ALREADY_INITIALIZED) {
 ...
 */
void polycall_jvm_bridge_cleanup(polycall_core_context_t *ctx,
                                 polycall_ffi_context_t *ffi_ctx,
                                 polycall_jvm_bridge_t *jvm_bridge) {
  ...
  if (jvm_bridge->owns_jvm && jvm_bridge->jvm) {
    ...
    // For completeness, would use
    // (*jvm_bridge->jvm)->DestroyJavaVM(jvm_bridge->jvm);
  }
...
polycall_core_error_t polycall_jvm_bridge_register_method(
    ...
    polycall_jvm_bridge_t *jvm_bridge, const char *function_name,
    const java_method_signature_t *java_method, uint32_t flags) {
  ...
  if (jvm_bridge->method_count >= jvm_bridge->method_capacity) {
    POLYCALL_ERROR_SET(
        ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_CAPACITY_EXCEEDED,
        POLYCALL_ERROR_SEVERITY_ERROR, "Method registry capacity exceeded");
  ...
  if (!local_class) {
    check_java_exception(ctx, env, NULL, 0);
    POLYCALL_ERROR_SET(
        ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_INVALID_PARAMETERS,
        POLYCALL_ERROR_SEVERITY_ERROR, "Failed to find Java class: %s",
  ...
  if (java_method->is_static) {
    method_id = (*env)->GetStaticMethodID(env, global_class, java_method->name,
                                          java_method->signature);
  } else {
    method_id = (*env)->GetMethodID(env, global_class, java_method->name,
                                    java_method->signature);
  }
  ...
  if (!method_id) {
    ...
    POLYCALL_ERROR_SET(
        ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_INVALID_PARAMETERS,
        POLYCALL_ERROR_SEVERITY_ERROR, "Failed to find Java method: %s%s %s",
        java_method->is_static ? "static " : "", java_method->name,
        java_method->signature);
    return POLYCALL_CORE_ERROR_INVALID_PARAMETERS;
  }

  // Create a signature for the FFI system
  // A real implementation would analyze the Java method signature to determine
  // parameter types This is a placeholder implementation
  ...
  method->method_info.name =
      polycall_core_malloc(ctx, strlen(java_method->name) + 1);
  method->method_info.signature =
      polycall_core_malloc(ctx, strlen(java_method->signature) + 1);
  method->method_info.class_name =
      polycall_core_malloc(ctx, strlen(java_method->class_name) + 1);

  if (!method->method_info.name || !method->method_info.signature ||
      !method->method_info.class_name) {
    if (method->method_info.name)
      polycall_core_free(ctx, (void *)method->method_info.name);
    if (method->method_info.signature)
      polycall_core_free(ctx, (void *)method->method_info.signature);
    if (method->method_info.class_name)
  ...
  result = polycall_ffi_expose_function(ctx, ffi_ctx, function_name, method,
                                        signature, "java", flags);
...
polycall_core_error_t polycall_jvm_bridge_call_method(
  ...
  if (!ctx || !ffi_ctx || !jvm_bridge || !function_name ||
  ...
  if (!method) {
    POLYCALL_ERROR_SET(
        ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_INVALID_PARAMETERS,
        POLYCALL_ERROR_SEVERITY_ERROR, "Method %s not found", function_name);
    return POLYCALL_CORE_ERROR_INVALID_PARAMETERS;
  }
  ...
  if (arg_count > 0) {
    ...
    for (size_t i = 0; i < arg_count; i++) {
      ...
      // convert based on Java method signature and handle various types
  ...
  if (method->method_info.is_static) {
    ...
    // various return types based on Java method signature
    java_result = (*env)->CallStaticObjectMethodA(env, method->class_ref,
                                                  method->method_id, jargs);
  } else {
    // For non-static methods, we need an object instance
    // This is a placeholder - real implementation would need to handle object
    // instances
    POLYCALL_ERROR_SET(ctx, POLYCALL_ERROR_SOURCE_FFI,
                       POLYCALL_CORE_ERROR_UNSUPPORTED_OPERATION,
                       POLYCALL_ERROR_SEVERITY_ERROR,
  ...
  error = java_to_ffi_value(ctx, jvm_bridge, env, java_result,
                            POLYCALL_FFI_TYPE_OBJECT, result);
...
polycall_core_error_t polycall_jvm_bridge_to_java_value(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_jvm_bridge_t *jvm_bridge, const ffi_value_t *ffi_value,
    void *jni_env, void **java_value) {
  if (!ctx || !ffi_ctx || !jvm_bridge || !ffi_value || !jni_env ||
      !java_value) {
    return POLYCALL_CORE_ERROR_INVALID_PARAMETERS;
  }
  ...
  jobject result =
      ffi_to_java_value(ctx, jvm_bridge, (JNIEnv *)jni_env, ffi_value);
...
polycall_core_error_t polycall_jvm_bridge_from_java_value(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_jvm_bridge_t *jvm_bridge, void *java_value, void *jni_env,
  ...
  return java_to_ffi_value(ctx, jvm_bridge, (JNIEnv *)jni_env,
                           (jobject)java_value, expected_type, ffi_value);
}
...
polycall_core_error_t polycall_jvm_bridge_register_callback(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_jvm_bridge_t *jvm_bridge, const char *callback_class,
    const char *callback_method, ffi_signature_t *signature) {
  if (!ctx || !ffi_ctx || !jvm_bridge || !callback_class || !callback_method ||
      !signature) {
    return POLYCALL_CORE_ERROR_INVALID_PARAMETERS;
  }
  ...
  if (find_callback(jvm_bridge, callback_class, callback_method)) {
    POLYCALL_ERROR_SET(
        ...
        POLYCALL_ERROR_SEVERITY_WARNING, "Callback %s.%s already registered",
  ...
  if (jvm_bridge->callback_count >= jvm_bridge->callback_capacity) {
    POLYCALL_ERROR_SET(
        ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_CAPACITY_EXCEEDED,
        POLYCALL_ERROR_SEVERITY_ERROR, "Callback registry capacity exceeded");
    return POLYCALL_CORE_ERROR_CAPACITY_EXCEEDED;
  }
  ...
  // For instance methods, we would need to create and keep an instance of the
  // class
  ...
  jmethodID method_id = (*env)->GetStaticMethodID(
      env, global_class, callback_method, method_signature);
  ...
  java_callback_t *callback =
      &jvm_bridge->callbacks[jvm_bridge->callback_count];

  // Copy callback class and method names
  callback->callback_class =
      polycall_core_malloc(ctx, strlen(callback_class) + 1);
  callback->callback_method =
      polycall_core_malloc(ctx, strlen(callback_method) + 1);
...
polycall_core_error_t polycall_jvm_bridge_handle_exception(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_jvm_bridge_t *jvm_bridge, void *jni_env, char *error_message,
    size_t message_size) {
  if (!ctx || !ffi_ctx || !jvm_bridge || !jni_env) {
    return POLYCALL_CORE_ERROR_INVALID_PARAMETERS;
  }

  return check_java_exception(ctx, (JNIEnv *)jni_env, error_message,
                              message_size);
}
 ...
 */
polycall_core_error_t
polycall_jvm_bridge_get_env(polycall_core_context_t *ctx,
                            polycall_ffi_context_t *ffi_ctx,
                            polycall_jvm_bridge_t *jvm_bridge, void **jni_env) {
  if (!ctx || !ffi_ctx || !jvm_bridge || !jni_env) {
    return POLYCALL_CORE_ERROR_INVALID_PARAMETERS;
  }
...
polycall_core_error_t polycall_jvm_bridge_get_interface(
    polycall_core_context_t *ctx, polycall_ffi_context_t *ffi_ctx,
    polycall_jvm_bridge_t *jvm_bridge, language_bridge_t *bridge) {
...
static polycall_core_error_t jvm_convert_to_native(polycall_core_context_t *ctx,
                                                   const ffi_value_t *src,
                                                   void *dest,
                                                   ffi_type_info_t *dest_type) {
  // Implementation would depend on specific integration needs
  // This is a placeholder - real implementation would convert FFI values to JNI
  // types
  POLYCALL_ERROR_SET(ctx, POLYCALL_ERROR_SOURCE_FFI,
                     POLYCALL_CORE_ERROR_UNSUPPORTED_OPERATION,
                     POLYCALL_ERROR_SEVERITY_ERROR,
...
static polycall_core_error_t
jvm_convert_from_native(polycall_core_context_t *ctx, const void *src,
                        ffi_type_info_t *src_type, ffi_value_t *dest) {
  // Implementation would depend on specific integration needs
  // This is a placeholder - real implementation would convert JNI types to FFI
  // values
  POLYCALL_ERROR_SET(ctx, POLYCALL_ERROR_SOURCE_FFI,
                     POLYCALL_CORE_ERROR_UNSUPPORTED_OPERATION,
                     POLYCALL_ERROR_SEVERITY_ERROR,
...
static polycall_core_error_t jvm_register_function(polycall_core_context_t *ctx,
                                                   const char *function_name,
                                                   void *function_ptr,
                                                   ffi_signature_t *signature,
                                                   uint32_t flags) {
  // This would be called by the FFI core when registering a function from
  // another language that needs to be callable from Java
...
static polycall_core_error_t
jvm_call_function(polycall_core_context_t *ctx, const char *function_name,
                  ffi_value_t *args, size_t arg_count, ffi_value_t *result) {
  // This would be called by the FFI core when calling a Java function
  // Extract JVM bridge from user_data
  polycall_jvm_bridge_t *jvm_bridge =
      (polycall_jvm_bridge_t *)ctx->current_user_data;
  if (!jvm_bridge) {
    POLYCALL_ERROR_SET(
        ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_INVALID_STATE,
        POLYCALL_ERROR_SEVERITY_ERROR, "JVM bridge context not available");
...
static polycall_core_error_t jvm_acquire_memory(polycall_core_context_t *ctx,
...
static polycall_core_error_t jvm_release_memory(polycall_core_context_t *ctx,
                                                void *ptr) {
  // Implementation would depend on specific memory management needs
  // This is a placeholder
  return POLYCALL_CORE_SUCCESS;
...
static polycall_core_error_t jvm_handle_exception(polycall_core_context_t *ctx,
                                                  void *exception,
                                                  char *message,
                                                  size_t message_size) {
  // Extract JVM bridge from user_data
...
static polycall_core_error_t jvm_initialize(polycall_core_context_t *ctx) {
  // This would be called when the language bridge is registered with the FFI
  // system No specific initialization needed beyond what's done in
  // polycall_jvm_bridge_init
  return POLYCALL_CORE_SUCCESS;
}

static void jvm_cleanup(polycall_core_context_t *ctx) {
  // This would be called when the language bridge is unregistered from the FFI
  // system No specific cleanup needed beyond what's done in
  // polycall_jvm_bridge_cleanup
}
 ...
 */
static polycall_core_error_t
java_to_ffi_value(polycall_core_context_t *ctx,
                  polycall_jvm_bridge_t *jvm_bridge, JNIEnv *env,
                  jobject java_value, polycall_ffi_type_t expected_type,
  ...
  case POLYCALL_FFI_TYPE_BOOL: {
    ...
    ffi_value->value.bool_value =
        (*env)->CallBooleanMethod(env, java_value, booleanValue);
    (*env)->DeleteLocalRef(env, boolean_class);
  ...
  case POLYCALL_FFI_TYPE_CHAR: {
    ...
    jclass char_class = (*env)->FindClass(env, "java/lang/Character");
    jmethodID charValue =
        (*env)->GetMethodID(env, char_class, "charValue", "()C");
    ffi_value->value.char_value =
        (*env)->CallCharMethod(env, java_value, charValue);
    (*env)->DeleteLocalRef(env, char_class);
    return check_java_exception(ctx, env, NULL, 0);
  }
  ...
  case POLYCALL_FFI_TYPE_INT32: {
    ...
    jclass integer_class = (*env)->FindClass(env, "java/lang/Integer");
    jmethodID intValue =
        (*env)->GetMethodID(env, integer_class, "intValue", "()I");
  ...
  case POLYCALL_FFI_TYPE_INT64: {
    ...
    ffi_value->value.int64_value =
        (*env)->CallLongMethod(env, java_value, longValue);
    (*env)->DeleteLocalRef(env, long_class);
    return check_java_exception(ctx, env, NULL, 0);
  }
  ...
  case POLYCALL_FFI_TYPE_UINT64: {
    ...
    jmethodID longValue =
        (*env)->GetMethodID(env, long_class, "longValue", "()J");
    ffi_value->value.uint64_value =
        (uint64_t)(*env)->CallLongMethod(env, java_value, longValue);
    (*env)->DeleteLocalRef(env, long_class);
    return check_java_exception(ctx, env, NULL, 0);
  }
  ...
  case POLYCALL_FFI_TYPE_FLOAT: {
    ...
    jmethodID floatValue =
        (*env)->GetMethodID(env, float_class, "floatValue", "()F");
    ffi_value->value.float_value =
        (*env)->CallFloatMethod(env, java_value, floatValue);
    (*env)->DeleteLocalRef(env, float_class);
    return check_java_exception(ctx, env, NULL, 0);
  }
  ...
  case POLYCALL_FFI_TYPE_DOUBLE: {
    ...
    jmethodID doubleValue =
        (*env)->GetMethodID(env, double_class, "doubleValue", "()D");
    ffi_value->value.double_value =
        (*env)->CallDoubleMethod(env, java_value, doubleValue);
    (*env)->DeleteLocalRef(env, double_class);
    return check_java_exception(ctx, env, NULL, 0);
  }
  ...
  case POLYCALL_FFI_TYPE_STRING: {
    ...
    if (!(*env)->IsInstanceOf(env, java_value, string_class)) {
      ...
      POLYCALL_ERROR_SET(
          ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_TYPE_MISMATCH,
          POLYCALL_ERROR_SEVERITY_ERROR, "Java object is not a String");
  ...
  case POLYCALL_FFI_TYPE_POINTER: {
    ...
    if (!(*env)->IsInstanceOf(env, java_value, buffer_class)) {
      ...
      POLYCALL_ERROR_SET(
          ctx, POLYCALL_ERROR_SOURCE_FFI, POLYCALL_CORE_ERROR_TYPE_MISMATCH,
          POLYCALL_ERROR_SEVERITY_ERROR, "Java object is not a ByteBuffer");
      return POLYCALL_CORE_ERROR_TYPE_MISMATCH;
    }
