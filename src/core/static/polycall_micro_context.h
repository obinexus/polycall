...
typedef polycall_core_error_t (*polycall_command_handler_t)(
    ...
    polycall_micro_component_t *component, void *params, void *result,
    void *user_data);
...
typedef enum {
  ...
  POLYCALL_COMMAND_FLAG_READONLY =
      (1 << 3), // Command does not modify component state
  ...
  POLYCALL_COMMAND_FLAG_EXTERNAL =
      (1 << 6), // Command accessible from external sources
...
struct polycall_micro_config {
  ...
  void (*error_callback)(      // Error callback
      polycall_core_context_t *ctx, polycall_micro_context_t *micro_ctx,
      polycall_core_error_t error, const char *message, void *user_data);
};
...
polycall_micro_init(polycall_core_context_t *core_ctx,
 ...
 */
polycall_core_error_t
polycall_micro_start_component(polycall_core_context_t *core_ctx,
                               polycall_micro_context_t *micro_ctx,
                               polycall_micro_component_t *component);
 ...
 */
polycall_core_error_t
polycall_micro_stop_component(polycall_core_context_t *core_ctx,
                              polycall_micro_context_t *micro_ctx,
                              polycall_micro_component_t *component);
...
polycall_core_error_t polycall_micro_get_component_state(
    polycall_core_context_t *core_ctx, polycall_micro_context_t *micro_ctx,
    polycall_micro_component_t *component, polycall_component_state_t *state);
 ...
 */
polycall_core_error_t
polycall_micro_integrate_ffi(polycall_core_context_t *core_ctx,
                             polycall_micro_context_t *micro_ctx,
