...
extern "C" {
   ...
   typedef polycall_core_error_t (*polycall_message_handler_t)(
       polycall_core_context_t * ctx, polycall_message_t * message,
       void *user_data);

   /* Message creation and destruction */
   polycall_core_error_t polycall_message_create(polycall_core_context_t * ctx,
                                                 polycall_message_t * *message,
                                                 polycall_message_type_t type);

   void polycall_message_destroy(polycall_core_context_t * ctx,
                                 polycall_message_t * message);
   ...
   polycall_core_error_t polycall_message_serialize(
       polycall_core_context_t * ctx, const polycall_message_t *message,
   ...
   polycall_core_error_t polycall_message_register_handler(
       polycall_core_context_t * ctx, polycall_message_type_t type,
       polycall_message_handler_t handler, void *user_data);

   polycall_core_error_t polycall_message_dispatch(
       polycall_core_context_t * ctx, polycall_message_t * message);

   /* Message state observers */
   const void *polycall_message_get_payload(const polycall_message_t *message,
                                            size_t *size);

   const void *polycall_message_get_metadata(const polycall_message_t *message,
                                             size_t *size);
   ...
   uint32_t polycall_message_get_sequence(const polycall_message_t *message);
   ...
   polycall_core_error_t polycall_message_cleanup_pool(polycall_core_context_t *
                                                       ctx);
