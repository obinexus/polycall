 ...
 *
 * This module provides configuration parsing, validation, storage, and
 * application for the LibPolyCall edge computing system, supporting both global
...
/* Forward declaration of config node type to prevent undefined identifier
 * errors */
 ...
 * @note This definition resolves duplication between polycall_event.h and
 * compute_router.h
 */
...
/* Forward declaration of compute router context to resolve circular
 * dependencies */
typedef struct polycall_compute_router_context
...
typedef void (*polycall_routing_event_callback_t)(
    ...
    polycall_routing_event_t event_type, const char *node_id,
    const void *task_data, size_t task_size, void *user_data);
/**
...
typedef enum {
  ...
  EDGE_CONFIG_VALIDATE_SECURITY =
      3,                          // Full validation including security policies
...
typedef struct {
  polycall_router_selection_strategy_t
      selection_strategy;        // Router selection strategy
...
polycall_core_error_t polycall_edge_config_manager_load(
    polycall_core_context_t *core_ctx,
    polycall_edge_config_manager_t *config_manager,
    polycall_edge_config_load_status_t *load_status, char *error_buffer,
...
polycall_core_error_t polycall_edge_config_manager_get_component_config(
    polycall_core_context_t *core_ctx,
    polycall_edge_config_manager_t *config_manager, const char *component_name,
...
polycall_core_error_t polycall_edge_config_manager_get_string(
    polycall_core_context_t *core_ctx,
    polycall_edge_config_manager_t *config_manager, const char *path,
...
polycall_core_error_t polycall_edge_config_manager_get_int(
    polycall_core_context_t *core_ctx,
    polycall_edge_config_manager_t *config_manager, const char *path,
    int64_t default_value, int64_t *result);
...
polycall_core_error_t polycall_edge_config_manager_set_value(
    polycall_core_context_t *core_ctx,
    polycall_edge_config_manager_t *config_manager, const char *path,
    polycall_config_value_type_t value_type, const void *value);
...
polycall_core_error_t polycall_edge_config_manager_save(
    polycall_core_context_t *core_ctx,
    polycall_edge_config_manager_t *config_manager, const char *file_path,
 ...
 */
polycall_edge_config_manager_options_t
polycall_edge_config_manager_default_options(void);
