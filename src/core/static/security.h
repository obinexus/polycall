...
typedef struct {
  ...
  polycall_edge_threat_level_t
      min_trust_level; // Minimum acceptable trust level
...
polycall_edge_security_init(polycall_core_context_t *core_ctx,
...
polycall_core_error_t polycall_edge_security_authenticate(
    ...
    polycall_edge_security_context_t *security_ctx, const void *auth_token,
    size_t token_size);
 ...
 */
polycall_core_error_t
polycall_edge_security_revoke(polycall_core_context_t *core_ctx,
                              polycall_edge_security_context_t *security_ctx);
