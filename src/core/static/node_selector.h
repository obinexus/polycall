 ...
 *
 * Provides advanced node selection mechanisms for distributed computational
routing
 */
...
polycall_core_error_t polycall_node_selector_select(
    polycall_node_selector_context_t *selector_ctx,
    const polycall_edge_node_metrics_t *task_requirements, char *selected_node);
...
polycall_core_error_t polycall_node_selector_update_metrics(
    polycall_node_selector_context_t *selector_ctx, const char *node_id,
...
polycall_core_error_t polycall_node_selector_record_task(
    polycall_node_selector_context_t *selector_ctx, const char *node_id,
    bool task_success, uint32_t execution_time);
