 ...
 *
 * Provides advanced computational task routing mechanisms for distributed
 * computing
 */
...
polycall_core_error_t polycall_compute_router_init(
    ...
    polycall_routing_event_callback_t event_callback, void *user_data);
...
polycall_core_error_t polycall_compute_router_route_task(
    polycall_compute_router_context_t *router_ctx, const void *task_data,
    size_t task_size, const polycall_edge_node_metrics_t *task_requirements,
...
polycall_core_error_t polycall_compute_router_handle_node_failure(
    polycall_compute_router_context_t *router_ctx, const char *failed_node_id);
...
polycall_core_error_t polycall_compute_router_get_stats(
    polycall_compute_router_context_t *router_ctx, uint64_t *total_tasks,
