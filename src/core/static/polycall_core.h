 ...
 */
polycall_core_error_t polycall_core_set_error(struct polycall_core_context *ctx,
...
polycall_core_get_last_error(struct polycall_core_context *ctx,
                             const char **message);
 ...
 */
polycall_core_error_t
polycall_core_set_user_data(struct polycall_core_context *ctx, void *user_data);
