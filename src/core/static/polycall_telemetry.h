...
typedef void (*polycall_telemetry_callback_t)(
    const polycall_telemetry_event_t *event, void *user_data);
...
polycall_telemetry_init(polycall_core_context_t *core_ctx,
 ...
 */
polycall_core_error_t
polycall_telemetry_record_event(polycall_telemetry_context_t *telemetry_ctx,
...
polycall_core_error_t polycall_telemetry_register_callback(
    polycall_telemetry_context_t *telemetry_ctx,
    polycall_telemetry_callback_t callback, void *user_data);
 ...
 */
void polycall_telemetry_cleanup(polycall_core_context_t *core_ctx,
                                polycall_telemetry_context_t *telemetry_ctx);
