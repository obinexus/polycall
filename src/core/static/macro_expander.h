 ...
 *
 * This file defines the interfaces for macro registration, resolution, and
 * expansion within the configuration parser.
 */
 ...
 */
polycall_macro_def_t *polycall_macro_find(polycall_macro_expander_t *expander,
                                          const char *name);
 ...
 */
polycall_ast_node_t *
polycall_macro_expand_node(polycall_macro_expander_t *expander,
 ...
 * @return bool True if successful, false otherwise
 */
bool polycall_macro_expand_ast(polycall_macro_expander_t *expander,
                               polycall_ast_t *ast);
