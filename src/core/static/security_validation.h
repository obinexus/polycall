 ...
 * @brief Zero-Trust Security Model interfaces for LibPolyCall configuration
 * validation
 ...
 */
typedef struct polycall_security_validation_context
    polycall_security_validation_context_t;
 ...
 * @param is_privileged Whether the context is privileged (can use privileged
 * ports)
 */
