 ...
 * @brief Component registry and component management for LibPolyCall micro
 * command system
...
typedef void (*component_event_callback_t)(
    ...
    polycall_micro_component_t *component, polycall_component_state_t old_state,
    polycall_component_state_t new_state, void *user_data);
