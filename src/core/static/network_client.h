...
struct polycall_network_client {
  ...
  // Callbacks
  void (*connection_callback)(polycall_network_client_t *client,
                              polycall_endpoint_t *endpoint, bool connected,
                              void *user_data);

  void (*error_callback)(polycall_network_client_t *client,
  ...
  struct {
    ...
    void (*handler)(polycall_network_client_t *client,
...
process_pending_requests(polycall_core_context_t *ctx,
                         polycall_network_client_t *client,
                         client_endpoint_t *client_endpoint);

static pending_request_t *
find_pending_request(client_endpoint_t *client_endpoint, uint32_t request_id);

static void remove_pending_request(polycall_core_context_t *ctx,
                                   client_endpoint_t *client_endpoint,
                                   pending_request_t *request);

static void trigger_client_event(polycall_network_client_t *client,
                                 polycall_endpoint_t *endpoint,
                                 polycall_network_event_t event_type,
                                 void *event_data);

static polycall_core_error_t
add_pending_request(polycall_core_context_t *ctx,
                    client_endpoint_t *client_endpoint, uint32_t request_id,
                    uint32_t timeout_ms);
/**
...
struct polycall_network_client_config {
  ...
  void (*connection_callback)(     // Connection state change callback
      polycall_network_client_t *client, polycall_endpoint_t *endpoint,
      bool connected, void *user_data);
  void (*error_callback)( // Error callback
      polycall_network_client_t *client, polycall_core_error_t error,
...
polycall_network_client_create(polycall_core_context_t *ctx,
                               polycall_protocol_context_t *proto_ctx,
                               polycall_network_client_t **client,
...
polycall_core_error_t polycall_network_client_connect(
    polycall_core_context_t *ctx, polycall_network_client_t *client,
 ...
 */
polycall_core_error_t
polycall_network_client_disconnect(polycall_core_context_t *ctx,
                                   polycall_network_client_t *client,
                                   polycall_endpoint_t *endpoint);
 ...
 */
polycall_core_error_t
polycall_network_client_get_stats(polycall_core_context_t *ctx,
                                  polycall_network_client_t *client,
                                  polycall_network_stats_t *stats);
...
polycall_core_error_t polycall_network_client_set_event_callback(
    polycall_core_context_t *ctx, polycall_network_client_t *client,
    polycall_network_event_t event_type,
    void (*callback)(polycall_network_client_t *client,
                     polycall_endpoint_t *endpoint, void *event_data,
                     void *user_data),
    void *user_data);
 ...
 */
polycall_core_error_t
polycall_network_client_process_events(polycall_core_context_t *ctx,
                                       polycall_network_client_t *client,
                                       uint32_t timeout_ms);
 ...
 * @param client Network client
 */
void polycall_network_client_cleanup(polycall_core_context_t *ctx,
                                     polycall_network_client_t *client);
 ...
 */
polycall_network_client_config_t
polycall_network_client_create_default_config(void);
