...
typedef enum {
  ...
  POLYCALL_ERROR_SEVERITY_FATAL,
  typedef enum polycall_error_severity{
      POLYCALL_ERROR_SEVERITY_INFO = 0, POLYCALL_ERROR_SEVERITY_WARNING,
      POLYCALL_ERROR_SEVERITY_ERROR,
      POLYCALL_ERROR_SEVERITY_FATAL} polycall_error_severity_t;
}
polycall_error_severity_t;
...
polycall_core_error_t polycall_error_set_full(
    polycall_core_context_t *ctx, polycall_error_source_t source, int32_t code,
    typedef enum polycall_error_severity{
        POLYCALL_ERROR_SEVERITY_INFO = 0, POLYCALL_ERROR_SEVERITY_WARNING,
        POLYCALL_ERROR_SEVERITY_ERROR,
        POLYCALL_ERROR_SEVERITY_FATAL} polycall_error_severity_t;
