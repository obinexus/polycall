...
typedef polycall_result_t (*polycall_handler_t)(void *context, void *input,
                                                void *output);

/* Error handling callbacks */
typedef void (*polycall_error_callback_t)(polycall_error_context_t *error_ctx,
                                          const polycall_error_record_t *error);

/* Logging callbacks */
typedef void (*polycall_log_callback_t)(polycall_log_level_t level,
                                        const char *module,
                                        const char *message);
