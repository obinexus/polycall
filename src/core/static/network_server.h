...
#include "polycall/core/protocol/polycall_protocol_context.h"
 ...
 extern "C" {
   ...
   typedef struct polycall_network_server_config
       polycall_network_server_config_t;
...
#define POLYCALL_NETWORK_NETWORK_SERVER_H_H
   ...
   typedef struct {
     ...
     void (*handler)(polycall_network_server_t *server,
   ...
   struct polycall_network_server {
     ...
     // Callbacks
     void (*connection_callback)(polycall_network_server_t *server,
                                 polycall_endpoint_t *endpoint, bool connected,
                                 void *user_data);

     void (*error_callback)(polycall_network_server_t *server,
                            polycall_core_error_t error, const char *message,
                            void *user_data);
   };
   ...
   static void handle_endpoint_event(polycall_endpoint_t * endpoint,
                                     void *event_data, void *user_data);
   static void trigger_server_event(
       polycall_network_server_t * server, polycall_endpoint_t * endpoint,
       polycall_network_event_t event_type, void *event_data);
   static polycall_core_error_t process_incoming_data(
       polycall_core_context_t * ctx, polycall_network_server_t * server,
       server_endpoint_t * server_endpoint);
   static void cleanup_endpoint(polycall_core_context_t * ctx,
                                polycall_network_server_t * server,
                                server_endpoint_t * server_endpoint);
   static bool initialize_socket(polycall_core_context_t * ctx,
                                 polycall_network_server_t * server);
   static bool initialize_tls(polycall_core_context_t * ctx,
                              polycall_network_server_t * server);
   static bool initialize_worker_threads(polycall_core_context_t * ctx,
                                         polycall_network_server_t * server);
   static server_endpoint_t *find_endpoint_by_id(
       polycall_network_server_t * server, uint32_t endpoint_id);
   ...
   typedef polycall_core_error_t (*polycall_message_handler_t)(
       ...
       polycall_endpoint_t * endpoint, polycall_message_t * message,
       polycall_message_t * *response, void *user_data);
   ...
   struct polycall_network_server_config {
     ...
     bool enable_protocol_dispatch;  // Enable automatic protocol message
                                     // dispatching
     ...
     void (*error_callback)( // Error callback
         polycall_network_server_t *server, polycall_core_error_t error,
   ...
   polycall_core_error_t polycall_network_server_accept(
       polycall_core_context_t * ctx, polycall_network_server_t * server,
       polycall_endpoint_t * *endpoint, uint32_t timeout_ms);
   ...
   polycall_core_error_t polycall_network_server_send(
       polycall_core_context_t * ctx, polycall_network_server_t * server,
       polycall_endpoint_t * endpoint, polycall_network_packet_t * packet,
       uint32_t timeout_ms);
   ...
   polycall_core_error_t polycall_network_server_broadcast(
       polycall_core_context_t * ctx, polycall_network_server_t * server,
       polycall_network_packet_t * packet, uint32_t timeout_ms);
   ...
   polycall_core_error_t polycall_network_server_register_handler(
       polycall_core_context_t * ctx, polycall_network_server_t * server,
       uint32_t message_type, polycall_message_handler_t handler,
       void *user_data);
   ...
   polycall_core_error_t polycall_network_server_get_endpoints(
       polycall_core_context_t * ctx, polycall_network_server_t * server,
       polycall_endpoint_t * *endpoints, size_t * count);
   ...
   polycall_core_error_t polycall_network_server_set_event_callback(
       polycall_core_context_t * ctx, polycall_network_server_t * server,
       polycall_network_event_t event_type,
       void (*callback)(polycall_network_server_t * server,
                        polycall_endpoint_t * endpoint, void *event_data,
                        void *user_data),
       void *user_data);
    ...
    * @param server Network server
    */
   void polycall_network_server_cleanup(polycall_core_context_t * ctx,
                                        polycall_network_server_t * server);
    ...
    */
   polycall_network_server_config_t
   polycall_network_server_create_default_config(void);
