...
struct polycall_socket_connection {
  ...
  // Message handling
  void (*message_handler)(polycall_socket_connection_t *connection,
...
typedef void (*polycall_socket_message_handler_t)(
    ...
    const polycall_socket_message_t *message, void *user_data);

/**
 * @brief WebSocket event callback type
 */
typedef void (*polycall_socket_callback_t)(
    polycall_socket_connection_t *connection, void *user_data);
 ...
 */
polycall_core_error_t
polycall_socket_start_server(polycall_socket_server_t *server);

/**
 * @brief Stop WebSocket server
 */
polycall_core_error_t
polycall_socket_stop_server(polycall_socket_server_t *server);
 ...
 */
static inline polycall_core_error_t
polycall_socket_send_text(polycall_socket_connection_t *connection,
                          const char *text) {
  return polycall_socket_send(connection, text, strlen(text),
