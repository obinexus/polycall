...
typedef struct {
  ...
  polycall_permission_inheritance_t
      inheritance_model; /**< Permission inheritance model */
  uint32_t
      permissions[POLYCALL_MAX_STATE_PERMISSIONS]; /**< State permissions */
 ...
 */
typedef struct polycall_hierarchical_state_context
    polycall_hierarchical_state_context_t;
...
bool polycall_hierarchical_state_has_permission(
    polycall_core_context_t *core_ctx,
    polycall_hierarchical_state_context_t *hsm_ctx, const char *state_name,
    uint32_t permission);
...
polycall_core_error_t polycall_hierarchical_state_get_permissions(
    polycall_core_context_t *core_ctx,
    polycall_hierarchical_state_context_t *hsm_ctx, const char *state_name,
    uint32_t *permissions, uint32_t max_permissions,
...
polycall_core_error_t polycall_hierarchical_state_get_path(
    polycall_core_context_t *core_ctx,
    polycall_hierarchical_state_context_t *hsm_ctx, char *path_buffer,
    size_t buffer_size);
...
polycall_core_error_t polycall_hierarchical_state_get_parent(
    polycall_core_context_t *core_ctx,
    polycall_hierarchical_state_context_t *hsm_ctx, const char *state_name,
    char *parent_buffer, size_t buffer_size);
...
polycall_core_error_t polycall_hierarchical_state_get_children(
    polycall_core_context_t *core_ctx,
    polycall_hierarchical_state_context_t *hsm_ctx, const char *state_name,
    char children[][POLYCALL_SM_MAX_NAME_LENGTH], uint32_t max_children,
