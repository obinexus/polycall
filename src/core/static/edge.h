 ...
 * This structure contains all the internal contexts for the edge computing
 * module
 */
struct polycall_edge_context {
  ...
  polycall_compute_router_context_t
      *compute_router;                        /**< Compute router context */
  ...
  /* Callback system */
  void (*on_node_failure)(const char *node_id,
                          void *user_data); /**< Node failure callback */
  void (*on_task_completion)(const char *task_id, void *result,
                             size_t result_size,
                             void *user_data); /**< Task completion callback */
...
polycall_edge_init(polycall_core_context_t *core_ctx,
 ...
 */
polycall_core_error_t
polycall_edge_register_node(polycall_edge_context_t *edge_ctx,
 ...
 * @param selected_node Pointer to receive selected node information (buffer
 * must be at least 64 bytes)
 * @return Error code
 */
polycall_core_error_t
polycall_edge_route_task(polycall_edge_context_t *edge_ctx,
                         const void *task_data, size_t task_size,
                         char *selected_node);
 ...
 */
polycall_core_error_t
polycall_edge_execute_task(polycall_edge_context_t *edge_ctx,
                           const char *node_id, const void *task_data,
                           size_t task_size, void *result_buffer,
                           size_t *result_size);
 ...
 */
polycall_core_error_t
polycall_edge_handle_node_failure(polycall_edge_context_t *edge_ctx,
 ...
 */
polycall_core_error_t
polycall_edge_get_node_metrics(polycall_edge_context_t *edge_ctx,
                               const char *node_id,
 ...
 */
polycall_core_error_t
polycall_edge_authenticate_node(polycall_edge_context_t *edge_ctx,
                                const char *node_id, const void *auth_token,
                                size_t token_size);
 ...
 */
polycall_core_error_t
polycall_edge_assess_node_threat(polycall_edge_context_t *edge_ctx,
                                 const char *node_id,
...
polycall_core_error_t polycall_edge_create_task_checkpoint(
    polycall_edge_context_t *edge_ctx, const void *task_data, size_t task_size,
    size_t executed_portion, polycall_task_checkpoint_t *checkpoint);
 ...
 */
polycall_core_error_t
polycall_edge_resume_task(polycall_edge_context_t *edge_ctx,
...
polycall_core_error_t polycall_edge_get_statistics(
    polycall_edge_context_t *edge_ctx, uint64_t *total_tasks,
    uint64_t *successful_tasks, uint64_t *failed_tasks,
    uint64_t *recovery_attempts, uint64_t *successful_recoveries);
 ...
 */
void polycall_edge_cleanup(polycall_core_context_t *core_ctx,
                           polycall_edge_context_t *edge_ctx);
