...
typedef struct {
  ...
  uint32_t priority_thresholds[POLYCALL_MAX_PRIORITY_QUEUES]; /**< Priority
                                                                 thresholds */
  ...
  uint32_t
      min_message_size_for_compression; /**< Minimum size for compression */
...
typedef struct {
  ...
  uint32_t current_priority_distribution
      [POLYCALL_MAX_PRIORITY_QUEUES]; /**< Priority distribution */
} polycall_message_optimization_stats_t;

/**
 * @brief Message optimization context (opaque)
 */
typedef struct polycall_message_optimization_context
    polycall_message_optimization_context_t;
