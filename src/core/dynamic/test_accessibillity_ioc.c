...
setup_ioc_test_fixture(accessibility_test_fixture_t *fixture) {
  assert(fixture != NULL);
...
// Phase 1: Core context initialization from configuration
  ...
  fixture->core_ctx =
      polycall_core_context_create_from_file(fixture->config_file_path);
  if (!fixture->core_ctx) {
  ...
  fixture->access_ctx = polycall_accessibility_context_create_with_config(
      fixture->core_ctx, &fixture->test_config);
...
void test_accessibility_ioc_configuration_loading(void) {
  ...
  // ========================== ACT ============================
  get_config_result =
      polycall_accessibility_get_config(fixture.access_ctx, &retrieved_config);

  // ========================= ASSERT ===========================
  POLYCALL_TEST_ASSERT(get_config_result == POLYCALL_CORE_SUCCESS,
                       "Configuration retrieval should succeed");
  POLYCALL_TEST_ASSERT(retrieved_config.audio_enabled ==
                           fixture.test_config.audio_enabled,
                       "Audio enabled setting should match");
  POLYCALL_TEST_ASSERT(retrieved_config.visual_enabled ==
                           fixture.test_config.visual_enabled,
                       "Visual enabled setting should match");
  POLYCALL_TEST_ASSERT(retrieved_config.audio_volume ==
                           fixture.test_config.audio_volume,
                       "Audio volume setting should match");
  POLYCALL_TEST_ASSERT(retrieved_config.notification_tone ==
                           fixture.test_config.notification_tone,
...
void test_accessibility_ioc_service_locator(void) {
  ...
  // ========================== ACT ============================
  audio_interface =
      polycall_accessibility_get_audio_interface(fixture.access_ctx);
  visual_interface =
      polycall_accessibility_get_visual_interface(fixture.access_ctx);
  config_interface =
      polycall_accessibility_get_config_interface(fixture.access_ctx);
...
void test_accessibility_ioc_resource_management(void) {
  ...
  POLYCALL_TEST_ASSERT(post_cleanup_memory <= initial_memory + 64,
                       "Memory should be properly released during cleanup "
                       "(allowing 64 bytes tolerance)");
}
...
void test_accessibility_ioc_configuration_update(void) {
  ...
  // ========================== ACT ============================
  set_result =
      polycall_accessibility_set_config(fixture.access_ctx, &new_config);
  get_result =
      polycall_accessibility_get_config(fixture.access_ctx, &retrieved_config);
  ...
  POLYCALL_TEST_ASSERT(get_result == POLYCALL_CORE_SUCCESS,
                       "Configuration retrieval should succeed");
  POLYCALL_TEST_ASSERT(retrieved_config.audio_enabled ==
                           new_config.audio_enabled,
                       "Updated audio enabled setting should match");
  POLYCALL_TEST_ASSERT(retrieved_config.high_contrast ==
                           new_config.high_contrast,
