...
static polycall_command_response_t *test_command_handler(
    ...
    const polycall_command_message_t *message, void *user_data) {
  // Increment counter
  ...
  polycall_command_create_response(ctx, POLYCALL_COMMAND_STATUS_SUCCESS,
...
static polycall_command_validation_t test_command_validator(
    polycall_core_context_t *ctx, polycall_protocol_context_t *proto_ctx,
    const polycall_command_message_t *message, void *user_data) {
  polycall_command_validation_t result = {.status =
                                              POLYCALL_COMMAND_STATUS_SUCCESS,
                                          .error_code = 0,
                                          .error_message = ""};
...
static void setup(void) {
  ...
  polycall_command_config_t config = {.flags = 0,
...
static int test_command_registration(void) {
  // Register a command
  polycall_command_info_t command_info = {.command_id = 0, // Auto-generate ID
                                          .name = "test_command",
  ...
  result = polycall_command_find_by_id(test_ctx, test_registry, command_id,
                                       &retrieved_info);
  ...
  result = polycall_command_find_by_name(test_ctx, test_registry,
                                         "test_command", &retrieved_info);
...
static int test_command_message_creation(void) {
  ...
  polycall_command_info_t command_info = {.command_id = 1001,
                                          .name = "test_command",
                                          .handler = test_command_handler,
                                          .validator = NULL,
                                          .permissions = 0,
  ...
  polycall_core_error_t result =
      polycall_command_create_message(test_ctx, &message, 1001);
...
static int test_command_parameters(void) {
  ...
  polycall_core_error_t result = polycall_command_add_parameter(
      test_ctx, message, 1, POLYCALL_PARAM_TYPE_STRING, string_param,
      strlen(string_param) + 1, 0);
  ...
  result = polycall_command_add_parameter(test_ctx, message, 2,
                                          POLYCALL_PARAM_TYPE_INT32, &int_param,
                                          sizeof(int_param), 0);
  ...
  result = polycall_command_add_parameter(test_ctx, message, 3,
                                          POLYCALL_PARAM_TYPE_BOOL, &bool_param,
                                          sizeof(bool_param), 0);
  ...
  void *param_data;
  uint32_t param_size;
  result = polycall_command_get_parameter(test_ctx, message, 1,
                                          POLYCALL_PARAM_TYPE_STRING,
  ...
  result = polycall_command_get_parameter(test_ctx, message, 2,
                                          POLYCALL_PARAM_TYPE_INT32,
  ...
  result = polycall_command_get_parameter(test_ctx, message, 3,
                                          POLYCALL_PARAM_TYPE_BOOL,
  ...
  result = polycall_command_get_parameter(test_ctx, message, 999,
                                          POLYCALL_PARAM_TYPE_ANY, &param_data,
                                          &param_size);
...
static int test_command_serialization(void) {
  ...
  polycall_command_add_parameter(test_ctx, message, 1,
                                 POLYCALL_PARAM_TYPE_STRING, string_param,
                                 strlen(string_param) + 1, 0);

  polycall_command_add_parameter(test_ctx, message, 2,
                                 POLYCALL_PARAM_TYPE_INT32, &int_param,
                                 sizeof(int_param), 0);

  polycall_command_add_parameter(test_ctx, message, 3, POLYCALL_PARAM_TYPE_BOOL,
  ...
  polycall_core_error_t result =
      polycall_command_serialize(test_ctx, message, &buffer, &buffer_size);
  ...
  result = polycall_command_deserialize(test_ctx, buffer, buffer_size,
                                        &deserialized);
  ...
  ASSERT_EQUAL_INT(message->header.param_count,
                   deserialized->header.param_count);

  // Verify parameters
  char *string_value;
  uint32_t string_size = 256;
  result = polycall_command_get_parameter(test_ctx, deserialized, 1,
                                          POLYCALL_PARAM_TYPE_STRING,
  ...
  result = polycall_command_get_parameter(test_ctx, deserialized, 2,
                                          POLYCALL_PARAM_TYPE_INT32, &int_value,
                                          &int_size);
  ...
  result = polycall_command_get_parameter(test_ctx, deserialized, 3,
                                          POLYCALL_PARAM_TYPE_BOOL, &bool_value,
                                          &bool_size);
...
static int test_command_execution(void) {
  // Register a command
  polycall_command_info_t command_info = {.command_id = 2000,
                                          .name = "test_execution",
                                          .handler = test_command_handler,
                                          .validator = NULL,
                                          .permissions = 0,
  ...
  polycall_command_add_parameter(test_ctx, message, 1,
                                 POLYCALL_PARAM_TYPE_STRING, param,
                                 strlen(param) + 1, 0);
...
static int test_command_validation(void) {
  ...
  polycall_command_info_t command_info = {.command_id = 3000,
  ...
  polycall_core_error_t result =
      polycall_command_execute(test_ctx, test_registry, test_proto_ctx,
  ...
  polycall_command_add_parameter(test_ctx, valid_message, 1,
                                 POLYCALL_PARAM_TYPE_STRING, param,
                                 strlen(param) + 1, 0);
  ...
  result = polycall_command_execute(test_ctx, test_registry, test_proto_ctx,
                                    valid_message, &valid_response);
...
static int test_command_unregistration(void) {
  // Register a command
  polycall_command_info_t command_info = {.command_id = 4000,
  ...
  result = polycall_command_find_by_id(test_ctx, test_registry, 4000,
                                       &retrieved_info);
  ASSERT_EQUAL_INT(POLYCALL_CORE_ERROR_INVALID_PARAMETERS, result);
...
static int test_command_response_creation(void) {
  ...
  polycall_core_error_t result = polycall_command_create_response(
      test_ctx, POLYCALL_COMMAND_STATUS_SUCCESS, success_data,
      strlen(success_data) + 1, &success_response);
  ...
  result = polycall_command_create_error_response(
      test_ctx, POLYCALL_COMMAND_ERROR_INVALID_PARAMETERS, "Invalid parameters",
      &error_response);

  ASSERT_EQUAL_INT(POLYCALL_CORE_SUCCESS, result);
  ASSERT_NOT_NULL(error_response);
  ASSERT_EQUAL_INT(POLYCALL_COMMAND_STATUS_ERROR, error_response->status);
  ASSERT_EQUAL_INT(POLYCALL_COMMAND_ERROR_INVALID_PARAMETERS,
...
static int test_response_serialization(void) {
  ...
  polycall_command_create_response(test_ctx, POLYCALL_COMMAND_STATUS_SUCCESS,
                                   response_data, strlen(response_data) + 1,
                                   &response);
  ...
  result = polycall_command_deserialize_response(test_ctx, buffer, buffer_size,
                                                 &deserialized);
  ...
  ASSERT_MEMORY_EQUAL(response_data, deserialized->response_data,
