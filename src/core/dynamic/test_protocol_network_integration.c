...
/**
 * @file test_protocol_network_integration.c
 ...
 */
int main(void) {
  printf("Starting INTEGRATION tests for modules: protocol network\n");
  printf("===========================================\n");
  ...
  printf("===========================================\n");
  printf("✅ All INTEGRATION tests passed for modules: protocol network\n");
