...
/**
 * @file test_edge_qa.c
 * @brief UNIT_QA tests for core/edge module
 ...
 */
int main(void) {
  printf("Starting UNIT_QA tests for core/edge\n");
  printf("==============================================\n");
  ...
  printf("==============================================\n");
  printf("✅ All UNIT_QA tests passed for core/edge\n");
