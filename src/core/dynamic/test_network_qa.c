...
/**
 * @file test_network_qa.c
 * @brief UNIT_QA tests for core/network module
...
static void setup_test_fixture(void) {
  ...
  // Arrange: Initialize network context
  result =
      polycall_network_init(g_fixture.core_ctx, &g_fixture.network_ctx, NULL);
  assert(result == POLYCALL_CORE_SUCCESS);
  assert(g_fixture.network_ctx != NULL);
}
 ...
 */
int main(void) {
  printf("Starting UNIT_QA tests for core/network\n");
  printf("==============================================\n");
  ...
  printf("==============================================\n");
  printf("✅ All UNIT_QA tests passed for core/network\n");
