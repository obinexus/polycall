 ...
 *
 * This file contains unit tests for the client-side networking interface in
 * LibPolyCall.
 */
...
static void test_connection_callback(polycall_network_client_t *client,
...
static void test_error_callback(polycall_network_client_t *client,
...
static void test_event_handler(polycall_network_client_t *client,
...
void test_client_create_cleanup(void) {
  ...
  polycall_core_error_t result =
      polycall_network_client_create(NULL, proto_ctx, &client, NULL);
...
void test_client_connect_disconnect(void) {
  ...
  polycall_core_error_t result = polycall_network_client_connect(
      NULL, client, "127.0.0.1", 8080, 1000, &endpoint);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_client_connect(core_ctx, NULL, "127.0.0.1", 8080,
                                           1000, &endpoint);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_client_connect(core_ctx, client, NULL, 8080, 1000,
                                           &endpoint);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_client_connect(core_ctx, client, "127.0.0.1", 8080,
                                           1000, NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_client_send_receive(void) {
  ...
  polycall_core_error_t result =
      polycall_network_client_send(NULL, client, endpoint, packet, 1000);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
  ...
  result = polycall_network_client_receive(NULL, client, endpoint, &recv_packet,
                                           1000);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_client_receive(core_ctx, NULL, endpoint,
                                           &recv_packet, 1000);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_client_receive(core_ctx, client, NULL, &recv_packet,
                                           1000);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result =
      polycall_network_client_receive(core_ctx, client, endpoint, NULL, 1000);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_client_send_message(void) {
  ...
  result = polycall_network_client_send_message(core_ctx, client, proto_ctx,
                                                NULL, message, 1000, &response);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_client_set_event_callback(void) {
  ...
  result = polycall_network_client_set_event_callback(
      core_ctx, client, POLYCALL_NETWORK_EVENT_CONNECT, test_event_handler,
      NULL);
  assert(result == POLYCALL_CORE_SUCCESS);

  // Register for another event type
  result = polycall_network_client_set_event_callback(
      core_ctx, client, POLYCALL_NETWORK_EVENT_DISCONNECT, test_event_handler,
      NULL);
  assert(result == POLYCALL_CORE_SUCCESS);
...
void test_client_process_events(void) {
  ...
  // Test with NULL parameters
  polycall_core_error_t result =
      polycall_network_client_process_events(NULL, client, 1000);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_client_get_stats(void) {
  ...
  polycall_core_error_t result =
      polycall_network_client_get_stats(NULL, client, &stats);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_client_options(void) {
  ...
  polycall_core_error_t result = polycall_network_client_set_option(
      NULL, client, POLYCALL_NETWORK_OPTION_SOCKET_BUFFER_SIZE, &buf_size,
      sizeof(buf_size));
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_client_set_option(
      core_ctx, NULL, POLYCALL_NETWORK_OPTION_SOCKET_BUFFER_SIZE, &buf_size,
      sizeof(buf_size));
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_client_set_option(
      core_ctx, client, POLYCALL_NETWORK_OPTION_SOCKET_BUFFER_SIZE, NULL,
      sizeof(buf_size));
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
  ...
  result = polycall_network_client_get_option(
      NULL, client, POLYCALL_NETWORK_OPTION_SOCKET_BUFFER_SIZE,
      &retrieved_buf_size, &size);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_client_get_option(
      core_ctx, NULL, POLYCALL_NETWORK_OPTION_SOCKET_BUFFER_SIZE,
      &retrieved_buf_size, &size);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
  ...
  result = polycall_network_client_get_option(
      core_ctx, client, POLYCALL_NETWORK_OPTION_SOCKET_BUFFER_SIZE,
      &retrieved_buf_size, NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
