...
/**
 * @file test_telemetry_qa.c
 * @brief UNIT_QA tests for core/telemetry module
 ...
 */
int main(void) {
  printf("Starting UNIT_QA tests for core/telemetry\n");
  printf("==============================================\n");
  ...
  printf("==============================================\n");
  printf("✅ All UNIT_QA tests passed for core/telemetry\n");
