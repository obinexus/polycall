...
/**
 * @file test_polycall.c
 * @brief UNIT tests for core/polycall module
 ...
 */
int main(void) {
  printf("Starting UNIT tests for core/polycall\n");
  printf("==============================================\n");
  ...
  printf("==============================================\n");
  printf("✅ All UNIT tests passed for core/polycall\n");
