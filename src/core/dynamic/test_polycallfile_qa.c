...
/**
 * @file test_polycallfile_qa.c
 * @brief UNIT_QA tests for core/polycallfile module
...
static void setup_test_fixture(void) {
  ...
  result = polycall_polycallfile_init(g_fixture.core_ctx,
...
static void teardown_test_fixture(void) {
  if (g_fixture.polycallfile_ctx) {
    polycall_polycallfile_cleanup(g_fixture.core_ctx,
                                  g_fixture.polycallfile_ctx);
    g_fixture.polycallfile_ctx = NULL;
  }
 ...
 */
int main(void) {
  printf("Starting UNIT_QA tests for core/polycallfile\n");
  printf("==============================================\n");
  ...
  printf("==============================================\n");
  printf("✅ All UNIT_QA tests passed for core/polycallfile\n");
