...
/**
 * @file test_micro_qa.c
 * @brief UNIT_QA tests for core/micro module
 ...
 */
int main(void) {
  printf("Starting UNIT_QA tests for core/micro\n");
  printf("==============================================\n");
  ...
  printf("==============================================\n");
  printf("✅ All UNIT_QA tests passed for core/micro\n");
