...
/**
 * @file test_polycallrc.c
 * @brief UNIT tests for core/polycallrc module
...
void test_${module_name} _basic_initialization(void) {
  ...
  polycall_core_error_t result =
      polycall_${module_name} _init(ctx, &${module_name} _ctx, NULL);
...
void test_${module_name} _configuration(void) {
  ...
  polycall_core_error_t result =
      polycall_${module_name} _configure(g_fixture.core_ctx, ctx, &config);
 ...
 */
int main(void) {
  printf("Starting UNIT tests for core/polycallrc\n");
  printf("==============================================\n");
  ...
  printf("==============================================\n");
  printf("✅ All UNIT tests passed for core/polycallrc\n");
