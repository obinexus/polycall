...
/**
 * @file test_schema_qa.c
 * @brief UNIT_QA tests for core/schema module
...
#include <polycall/core/schema/schema.h>
...
static void setup_test_fixture(void) {
  ...
  // Arrange: Initialize schema context
  result =
      polycall_schema_init(g_fixture.core_ctx, &g_fixture.schema_ctx, NULL);
  assert(result == POLYCALL_CORE_SUCCESS);
  assert(g_fixture.schema_ctx != NULL);
}
...
static void teardown_test_fixture(void) {
  if (g_fixture.schema_ctx) {
    polycall_schema_cleanup(g_fixture.core_ctx, g_fixture.schema_ctx);
    g_fixture.schema_ctx = NULL;
  }
 ...
 */
int main(void) {
  printf("Starting UNIT_QA tests for core/schema\n");
  printf("==============================================\n");
  ...
  printf("==============================================\n");
  printf("✅ All UNIT_QA tests passed for core/schema\n");
