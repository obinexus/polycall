 ...
 *
 * This file contains unit tests for the configuration management interface in
 * LibPolyCall.
 */
...
static bool test_validation_callback(polycall_core_context_t *ctx,
...
static bool test_enum_callback(const char *section, const char *key,
                               void *user_data) {
  test_enum_count++;
...
void test_config_create_destroy(void) {
  ...
  polycall_core_error_t result =
      polycall_network_config_create(NULL, &config, NULL);
...
void test_config_set_validator(void) {
  ...
  // Test with NULL parameters
  polycall_core_error_t result = polycall_network_config_set_validator(
      NULL, config, test_validation_callback, NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_validator(
      core_ctx, NULL, test_validation_callback, NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  // Test with valid parameters
  int user_data = 12345;
  result = polycall_network_config_set_validator(
      core_ctx, config, test_validation_callback, &user_data);
  assert(result == POLYCALL_CORE_SUCCESS);
...
void test_config_set_get_int(void) {
  ...
  polycall_core_error_t result =
      polycall_network_config_set_int(NULL, config, "test", "int_value", 12345);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_int(core_ctx, NULL, "test", "int_value",
                                           12345);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_int(core_ctx, config, NULL, "int_value",
                                           12345);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result =
      polycall_network_config_set_int(core_ctx, config, "test", NULL, 12345);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  // Test set_int with valid parameters
  result = polycall_network_config_set_int(core_ctx, config, "test",
                                           "int_value", 12345);
  assert(result == POLYCALL_CORE_SUCCESS);
  ...
  int value = 0;
  result = polycall_network_config_get_int(NULL, config, "test", "int_value",
                                           &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_int(core_ctx, NULL, "test", "int_value",
                                           &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_int(core_ctx, config, NULL, "int_value",
                                           &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result =
      polycall_network_config_get_int(core_ctx, config, "test", NULL, &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_int(core_ctx, config, "test",
                                           "int_value", NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_config_set_get_uint(void) {
  ...
  polycall_core_error_t result = polycall_network_config_set_uint(
      NULL, config, "test", "uint_value", 12345);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_uint(core_ctx, NULL, "test",
                                            "uint_value", 12345);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_uint(core_ctx, config, NULL,
                                            "uint_value", 12345);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result =
      polycall_network_config_set_uint(core_ctx, config, "test", NULL, 12345);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  // Test set_uint with valid parameters
  result = polycall_network_config_set_uint(core_ctx, config, "test",
                                            "uint_value", 12345);
  assert(result == POLYCALL_CORE_SUCCESS);

  // Test get_uint with NULL parameters
  unsigned int value = 0;
  result = polycall_network_config_get_uint(NULL, config, "test", "uint_value",
                                            &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_uint(core_ctx, NULL, "test",
                                            "uint_value", &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_uint(core_ctx, config, NULL,
                                            "uint_value", &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result =
      polycall_network_config_get_uint(core_ctx, config, "test", NULL, &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_uint(core_ctx, config, "test",
                                            "uint_value", NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_config_set_get_bool(void) {
  ...
  polycall_core_error_t result = polycall_network_config_set_bool(
      NULL, config, "test", "bool_value", true);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_bool(core_ctx, NULL, "test",
                                            "bool_value", true);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_bool(core_ctx, config, NULL,
                                            "bool_value", true);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result =
      polycall_network_config_set_bool(core_ctx, config, "test", NULL, true);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  // Test set_bool with valid parameters
  result = polycall_network_config_set_bool(core_ctx, config, "test",
                                            "bool_value", true);
  assert(result == POLYCALL_CORE_SUCCESS);

  // Test get_bool with NULL parameters
  bool value = false;
  result = polycall_network_config_get_bool(NULL, config, "test", "bool_value",
                                            &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_bool(core_ctx, NULL, "test",
                                            "bool_value", &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_bool(core_ctx, config, NULL,
                                            "bool_value", &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result =
      polycall_network_config_get_bool(core_ctx, config, "test", NULL, &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_bool(core_ctx, config, "test",
                                            "bool_value", NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_config_set_get_string(void) {
  ...
  polycall_core_error_t result = polycall_network_config_set_string(
      NULL, config, "test", "string_value", "test string");
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_string(core_ctx, NULL, "test",
                                              "string_value", "test string");
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_string(core_ctx, config, NULL,
                                              "string_value", "test string");
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_string(core_ctx, config, "test", NULL,
                                              "test string");
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_string(core_ctx, config, "test",
                                              "string_value", NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
  ...
  char value[64];
  result = polycall_network_config_get_string(
      NULL, config, "test", "string_value", value, sizeof(value));
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_string(
      core_ctx, NULL, "test", "string_value", value, sizeof(value));
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_string(
      core_ctx, config, NULL, "string_value", value, sizeof(value));
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_string(core_ctx, config, "test", NULL,
                                              value, sizeof(value));
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_string(
      core_ctx, config, "test", "string_value", NULL, sizeof(value));
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_string(core_ctx, config, "test",
  ...
  result = polycall_network_config_get_string(
      core_ctx, config, "test", "string_value", value, sizeof(value));
  assert(result == POLYCALL_CORE_SUCCESS);
...
void test_config_set_get_float(void) {
  ...
  polycall_core_error_t result = polycall_network_config_set_float(
      NULL, config, "test", "float_value", 123.45f);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_float(core_ctx, NULL, "test",
                                             "float_value", 123.45f);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_float(core_ctx, config, NULL,
                                             "float_value", 123.45f);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_set_float(core_ctx, config, "test", NULL,
                                             123.45f);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  // Test set_float with valid parameters
  result = polycall_network_config_set_float(core_ctx, config, "test",
                                             "float_value", 123.45f);
  assert(result == POLYCALL_CORE_SUCCESS);

  // Test get_float with NULL parameters
  float value = 0.0f;
  result = polycall_network_config_get_float(NULL, config, "test",
                                             "float_value", &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_float(core_ctx, NULL, "test",
                                             "float_value", &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_float(core_ctx, config, NULL,
                                             "float_value", &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result =
      polycall_network_config_get_float(core_ctx, config, "test", NULL, &value);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_get_float(core_ctx, config, "test",
                                             "float_value", NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_config_load_save(void) {
  // Note: This test doesn't actually load/save from disk since that would
  // require file operations that are problematic in unit tests. Instead, we
  // just test the parameter validation.
  ...
  polycall_core_error_t result =
      polycall_network_config_load(NULL, config, "test_config.ini");
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
  ...
  // Since we're not actually writing to disk, just check that it accepted the
  // parameters
  assert(result != POLYCALL_CORE_ERROR_INVALID_PARAMETERS);
...
void test_config_reset(void) {
  ...
  polycall_network_config_set_string(core_ctx, config, "test", "string_value",
                                     "test string");
...
void test_config_enumerate(void) {
  ...
  polycall_network_config_set_int(core_ctx, config, "section1", "int_value1",
                                  12345);
  polycall_network_config_set_int(core_ctx, config, "section1", "int_value2",
                                  67890);
  polycall_network_config_set_string(core_ctx, config, "section2",
  ...
  test_enum_count = 0;
  polycall_core_error_t result = polycall_network_config_enumerate(
      NULL, config, "section1", test_enum_callback, NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_enumerate(core_ctx, NULL, "section1",
                                             test_enum_callback, NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_enumerate(core_ctx, config, NULL,
                                             test_enum_callback, NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  result = polycall_network_config_enumerate(core_ctx, config, "section1", NULL,
                                             NULL);
  assert(result == POLYCALL_CORE_ERROR_INVALID_PARAMETERS);

  // Test enumerate for section1
  test_enum_count = 0;
  result = polycall_network_config_enumerate(core_ctx, config, "section1",
                                             test_enum_callback, NULL);
  assert(result == POLYCALL_CORE_SUCCESS);
  ...
  test_enum_count = 0;
  result = polycall_network_config_enumerate(core_ctx, config, "section2",
                                             test_enum_callback, NULL);
  assert(result == POLYCALL_CORE_SUCCESS);
  ...
  test_enum_count = 0;
  result = polycall_network_config_enumerate(core_ctx, config, "",
                                             test_enum_callback, NULL);
  assert(result == POLYCALL_CORE_SUCCESS);
  ...
  test_enum_count = 0;
  result = polycall_network_config_enumerate(core_ctx, config, "non_existent",
                                             test_enum_callback, NULL);
  assert(result == POLYCALL_CORE_SUCCESS);
...
void test_config_validation(void) {
  ...
  polycall_network_config_set_validator(core_ctx, config,
                                        test_validation_callback, NULL);

  // Set a value to trigger validation
  polycall_core_error_t result = polycall_network_config_set_int(
      core_ctx, config, "test", "int_value", 12345);
  assert(result == POLYCALL_CORE_SUCCESS);
