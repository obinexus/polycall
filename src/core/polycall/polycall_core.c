...
polycall_core_error_t polycall_core_init(polycall_core_context_t **ctx,
  ...
  *ctx = new_ctx;
  ...
  if (new_ctx->config.flags & POLYCALL_CORE_FLAG_DEBUG_MODE) {
    polycall_core_log(new_ctx, POLYCALL_LOG_LEVEL_DEBUG,
                      "PolyCall Core initialized (version %s)",
                      POLYCALL_VERSION);
  }
...
polycall_core_error_t polycall_core_set_memory_functions(
    polycall_core_context_t *ctx, polycall_core_malloc_fn malloc_fn,
    polycall_core_free_fn free_fn, void *user_data) {
...
void polycall_core_free(polycall_core_context_t *ctx, void *ptr) {
  ...
  if (ctx->memory_pool && ptr >= ctx->memory_pool &&
...
polycall_core_error_t polycall_core_set_error(polycall_core_context_t *ctx,
...
polycall_core_error_t polycall_core_get_last_error(polycall_core_context_t *ctx,
                                                   const char **message) {
...
const char *polycall_core_get_version(void) { return POLYCALL_VERSION; }
...
polycall_core_error_t polycall_core_set_user_data(polycall_core_context_t *ctx,
                                                  void *user_data) {
...
void polycall_core_vlog(polycall_core_context_t *ctx,
                        polycall_log_level_t level, const char *format,
                        va_list args) {
  ...
  if (ctx->config.log_callback) {
    ...
    switch (level) {
    case POLYCALL_LOG_LEVEL_TRACE:
      level_str = "TRACE";
      break;
    case POLYCALL_LOG_LEVEL_DEBUG:
      level_str = "DEBUG";
      break;
    case POLYCALL_LOG_LEVEL_INFO:
      level_str = "INFO";
      break;
    case POLYCALL_LOG_LEVEL_WARN:
      level_str = "WARN";
      break;
    case POLYCALL_LOG_LEVEL_ERROR:
      level_str = "ERROR";
      break;
    case POLYCALL_LOG_LEVEL_FATAL:
      level_str = "FATAL";
      break;
    }
...
void polycall_core_log(polycall_core_context_t *ctx, polycall_log_level_t level,
                       const char *format, ...) {
 ...
 */
polycall_error_t
polycall_core_error_to_general(polycall_core_error_t core_error) {
  switch (core_error) {
...
polycall_core_set_unified_error(polycall_core_context_t *ctx,
                                polycall_core_error_t error,
                                const char *message) {
