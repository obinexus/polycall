...
polycall_auth_generate_session_id(polycall_core_context_t *core_ctx,
  ...
  polycall_core_error_t result =
      polycall_identifier_create(core_ctx, &identifier, auth_ctx->id_format);
...
polycall_core_error_t polycall_auth_generate_token_id(
    ...
    polycall_token_type_t token_type, char *buffer, size_t buffer_size) {
...
polycall_core_error_t
polycall_auth_set_identifier_format(polycall_core_context_t *core_ctx,
                                    polycall_auth_context_t *auth_ctx,
