 ...
 */
static bool
validate_polycallfile_ignore_context(polycallfile_ignore_context_t *ctx) {
...
polycallfile_ignore_init(polycall_core_context_t *core_ctx,
  ...
  polycallfile_ignore_context_t *ctx =
      polycall_core_malloc(core_ctx, sizeof(polycallfile_ignore_context_t));
  ...
  polycall_core_error_t result =
      polycall_ignore_context_init(core_ctx, &ctx->ctx, case_sensitive);
 ...
 */
void polycallfile_ignore_cleanup(polycall_core_context_t *core_ctx,
                                 polycallfile_ignore_context_t *ignore_ctx) {
 ...
 */
polycall_core_error_t
polycallfile_ignore_add_pattern(polycallfile_ignore_context_t *ignore_ctx,
                                const char *pattern) {
 ...
 */
polycall_core_error_t
polycallfile_ignore_load_file(polycallfile_ignore_context_t *ignore_ctx,
  ...
  if (!path) {
    ...
    if (polycall_path_resolve(ignore_ctx->core_ctx, DEFAULT_IGNORE_FILENAME,
                              resolved_path,
      ...
      if (polycall_path_get_home_directory(home_path, sizeof(home_path)) ==
          POLYCALL_CORE_SUCCESS) {

        snprintf(resolved_path, sizeof(resolved_path), "%s/%s", home_path,
  ...
  // Store the path
  ignore_ctx->ignore_file_path =
      polycall_core_strdup(ignore_ctx->core_ctx, path);
  if (!ignore_ctx->ignore_file_path) {
...
bool polycallfile_ignore_should_ignore(
    polycallfile_ignore_context_t *ignore_ctx, const char *path) {
 ...
 */
const char *
polycallfile_ignore_get_pattern(polycallfile_ignore_context_t *ignore_ctx,
                                size_t index) {
  if (!validate_polycallfile_ignore_context(ignore_ctx)) {
    return NULL;
  }
 ...
 */
polycall_core_error_t
polycallfile_ignore_add_defaults(polycallfile_ignore_context_t *ignore_ctx) {
  if (!validate_polycallfile_ignore_context(ignore_ctx)) {
    return POLYCALL_CORE_ERROR_INVALID_PARAMETERS;
  }
