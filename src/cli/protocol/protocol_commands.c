...
static int cmd_protocol_init(void *container, int argc, char **argv,
                             void *context) {
  ...
  polycall_protocol_context_t *protocol_ctx =
      malloc(sizeof(polycall_protocol_context_t));
  if (!protocol_ctx) {
...
static int cmd_protocol_state(void *container, int argc, char **argv,
                              void *context) {
  polycall_cli_container_t *cli = (polycall_cli_container_t *)container;

  // Get protocol context
  polycall_protocol_context_t *protocol_ctx =
      cli->resolve_service(cli, "protocol_context");
  if (!protocol_ctx) {
...
static int cmd_protocol_handshake(void *container, int argc, char **argv,
                                  void *context) {
  polycall_cli_container_t *cli = (polycall_cli_container_t *)container;
...
static int cmd_protocol_send(void *container, int argc, char **argv,
                             void *context) {
  polycall_cli_container_t *cli = (polycall_cli_container_t *)container;
  ...
  // Send message
  if (!polycall_protocol_send(protocol_ctx, type, payload, payload_length,
