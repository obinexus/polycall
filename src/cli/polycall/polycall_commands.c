...
static int cmd_core_init(void *container, int argc, char **argv,
                         void *context) {
...
// Show core version
static int cmd_core_version(void *container, int argc, char **argv,
                            void *context) {
...
static int cmd_core_cleanup(void *container, int argc, char **argv,
                            void *context) {
  polycall_cli_container_t *cli = (polycall_cli_container_t *)container;
...
void polycall_register_core_commands(void *registry) {
  ...
  static const polycall_command_t init_cmd = {
      ...
      .usage = "core init [--config-file <file>] [--debug] [--secure] "
               "[--memory-pool-size <size>]",
      .dependencies = NULL};

  static const polycall_command_t version_cmd = {.execute = cmd_core_version,
                                                 .name = "version",
                                                 .description =
                                                     "Show core version",
                                                 .usage = "core version",
