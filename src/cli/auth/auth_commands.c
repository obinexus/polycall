...
static command_result_t handle_auth_status(int argc, char **argv,
                                           void *context);
static command_result_t handle_auth_configure(int argc, char **argv,
                                              void *context);
...
static command_result_t handle_auth_status(int argc, char **argv,
  ...
  auth_container_t *container =
      polycall_get_service(core_ctx, "auth_container");
  if (!container) {
 ...
 */
int register_auth_commands(void) { return cli_register_command(&auth_command); }
