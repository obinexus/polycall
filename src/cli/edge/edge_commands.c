...
static command_result_t handle_edge_status(int argc, char **argv,
                                           void *context);
static command_result_t handle_edge_configure(int argc, char **argv,
                                              void *context);
...
static command_result_t handle_edge_status(int argc, char **argv,
  ...
  edge_container_t *container =
      polycall_get_service(core_ctx, "edge_container");
  if (!container) {
 ...
 */
int register_edge_commands(void) { return cli_register_command(&edge_command); }
