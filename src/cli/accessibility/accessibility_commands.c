...
// Define subcommands
static command_result_t handle_accessibility_help(int argc, char **argv,
                                                  void *context);
static command_result_t handle_accessibility_status(int argc, char **argv,
                                                    void *context);
static command_result_t handle_accessibility_configure(int argc, char **argv,
                                                       void *context);
...
static command_t accessibility_command = {
    ...
    .subcommand_count = sizeof(accessibility_subcommands) /
                        sizeof(accessibility_subcommands[0]),
    .requires_context = true};
...
static command_result_t handle_accessibility_help(int argc, char **argv,
                                                  void *context) {
  printf("%s - %s\n", accessibility_command.name,
         accessibility_command.description);
...
static command_result_t handle_accessibility_status(int argc, char **argv,
  ...
  accessibility_container_t *container =
      polycall_get_service(core_ctx, "accessibility_container");
  if (!container) {
